...
const REPORT_META = { asof: "31 Jul 2026", updated: "2026-07-31T09:30:00Z", label: "Jaissle 'here we go', Bruno-to-Arsenal closing, Bamba move confirmed" };
...
const CONFIRMED_IN = [
  ...
  {name:"Lukáš Horníček", sub:"24 · GK · Czech Republic", to:"from SC Braga", fee:"≈£24.5-30m (release clause)", free:false, status:"pending", statusTxt:"AGREED, RELEASE CLAUSE TRIGGERED",
   note:"Multiple outlets (TeamTalk, Shields Gazette, Football365) report the £24.5m-30m release clause has been triggered and personal terms are close, positioning Horníček as the senior alternative to Nick Pope after Newcastle again missed out on James Trafford (now signing for Leeds). Still described as 'advancing towards completion' rather than officially announced as of this refresh - held here pending, not moved to fully-confirmed, per the FootballTransfers.com gating rule; expect a formal unveiling within days."},
...
const CONFIRMED_OUT = [
  ...
  {name:"John Ruddy", sub:"39 · GK", to:"Released, free agent", fee:"Free (contract expired)", free:true, status:"exit", statusTxt:"DONE, DEPARTED",
  ...
  {name:"Matt Targett", sub:"26 · LB", to:"Hull City", fee:"Free", free:true, status:"exit", statusTxt:"DONE, DEPARTED",
  ...
  {name:"Harrison Ashby", sub:"23 · RB/LWB", to:"Luton Town (loan)", fee:"LOAN", free:true, status:"exit", statusTxt:"LOAN CONFIRMED",
  ...
  {name:"Travis Hernes", sub:"22 · CM", to:"FC Groningen", fee:"Undisclosed", status:"exit", statusTxt:"DONE, DEPARTED",
  ...
  {name:"Joe White", sub:"20 · CM · academy", to:"Crewe Alexandra", fee:"Undisclosed", status:"exit", statusTxt:"DONE, DEPARTED",
  ...
  {name:"Charlie McArthur", sub:"19 · academy", to:"York City", fee:"Undisclosed", status:"exit", statusTxt:"DONE, DEPARTED",
...
const INCOMING = [
  {name:"Matthias Jaissle", sub:"38 · Head Coach appointment", club:"Al-Ahli (Saudi Pro League)", pos:"Head coach", report:"31 Jul 2026", src:"Fabrizio Romano ('here we go') / Sky Germany / Florian Plettenberg (Goal.com)", tier:1, fee:"≈€11m compensation (PIF-to-PIF)", truth:88, prob:82, light:'g', trend:'up',
   note:"Escalated sharply since the 30 Jul vacancy opened. Fabrizio Romano has now called it 'here we go', Sky Germany frame it as a 'Done Deal' with terms agreed to 2030, and Plettenberg reports personal terms 'fully done', the release clause activated and Al-Ahli formally informed. Goal.com's latest (31 Jul) has Jaissle due to arrive in Newcastle Saturday 1 Aug for unveiling, with Newcastle paying Al-Ahli roughly €11m in compensation. Still no official NUFC statement at time of writing, so this stays a very-high-probability incoming rather than a formal confirmation."},
...
const OUTGOING = [
  ...
  {name:"Jacob Murphy", sub:"31 · RW/LW · England", club:"Everton", pos:"W", report:"28 Jul 2026", src:"Football Insider", tier:3, fee:"Bargain-fee speculation, undisclosed", truth:52, prob:26, light:'o', trend:'up',
   note:"Football Insider (28 Jul) reports Newcastle are 'now ready to accept the right offer' for Murphy, a step on from the pure enquiry-stage framing of the last refresh, though still no bid or fee agreed. A decade-long servant whose game time is squeezed by Bazoumana Touré's arrival and any Ezzalzouli deal."},
  {name:"Lewis Hall", sub:"22 · LB/LWB · England", club:"Manchester United / Chelsea", pos:"LB", report:"30 Jul 2026", src:"CaughtOffside (Simon Phillips)", tier:3, fee:"≈£55-60m", truth:48, prob:22, light:'o', trend:'up',
   note:"A genuine change since the last refresh: CaughtOffside's Simon Phillips (30 Jul) reports Manchester United's chase has stalled ('nothing has moved' recently), but Chelsea are now 'hovering' and see Hall as a 'dream target' to replace Marc Cucurella. No fee specifically reported for the Chelsea interest. Newcastle's prior £55-60m valuation still stands as the reference point; a sale would leave a fresh full-back hole alongside the Oso interest."},
...
const PROSE = {
  heroH2: `<em>Jaissle "here we go"</em>, Bruno-to-Arsenal closing in`,
  heroLede: `<b>Matthias Jaissle</b> has gone from advanced talks to Fabrizio Romano's <b>"here we go"</b>, due in Newcastle <b>Saturday 1 August</b> to be unveiled. The <b>Bruno Guimarães</b> sale to Arsenal is now "close to finalising", fee edging past £70m. Every other live thread, plus this refresh's confirmed-deals catch-up, is below.`,
  metaRow: `
