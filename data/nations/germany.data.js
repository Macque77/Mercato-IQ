...
const TOP_STORIES = [  {
  ...
  },
  {
    ...
    tier: 2, coverage: 1, coverage_trend: 'flat',
    value: "Valued around €6m (Transfermarkt)", updated: "2026-08-03T14:30:00Z", league: "Bundesliga"
  },
];

const BY_LEAGUE = {"Bundesliga": 33, "2. Bundesliga": 1, "3. Liga": 0, "Regionalliga": 0};

const LEAGUES_LIST = [{"slug": "bundesliga", "name": "Bundesliga", "count": 33}, {"slug": "2.-bundesliga", "name": "2. Bundesliga", "count": 1}, {"slug": "3.-liga", "name": "3. Liga", "count": 0}, {"slug": "regionalliga", "name": "Regionalliga", "count": 0}];

const REPORT_META = {
  asof: "06 Aug 2026",
  updated: "2026-08-06T08:45:13.637548Z",
