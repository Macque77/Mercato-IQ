...
const REPORT_META = { asof: "31 Jul 2026", updated: "2026-07-31T09:00:00Z", label: "Poku's Leverkusen deadline looms; Rusyn, Pembélé and Neil now confirmed" };
...
const CONFIRMED_OUT = [
  ...
  {name:"Dan Neil", sub:"24 · CM · academy", to:"Rangers", fee:"FREE", free:true, status:"exit", statusTxt:"EXIT CONFIRMED",
  ...
  {name:"Nazariy Rusyn", sub:"27 · ST · Ukraine", to:"Karpaty Lviv", fee:"Free/nominal", free:true, status:"exit", statusTxt:"EXIT CONFIRMED",
  ...
  {name:"Timothée Pembélé", sub:"22 · LB/RB · France", to:"Le Havre", fee:"FREE", free:true, status:"exit", statusTxt:"EXIT CONFIRMED",
  ...
  {name:"Zak Johnson", sub:"20 · CB", to:"York City", fee:"Undisclosed", status:"exit", statusTxt:"EXIT CONFIRMED",
...
const INCOMING = [
  ...
  {name:"Matthis Abline", sub:"22 · France · ST", club:"Nantes", pos:"ST", report:"~10 wks ago", src:"L'Équipe / Média Foot", tier:2, fee:"€20m bid rejected (~€50m ask)", truth:44, prob:10, light:'r', trend:'down',
   note:"Cooling further as the striker need eases and the thread goes quiet. Le Bris's 'two-and-a-half strikers' plan around Brobbey and Isidor has dropped the urgency for an out-and-out No.9. No fresh reporting found this refresh; L'Équipe's ~€50m Nantes ask (president Kita: 'intransférable') against a rejected ~€20m Sunderland offer remains the last word."},
