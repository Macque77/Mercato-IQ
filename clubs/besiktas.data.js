...
const CONFIRMED_OUT = [];
const INCOMING = [
  {name:"Mohamed Salah", sub:"33 · FW · Egypt", club:"Free agent (ex-Liverpool)", pos:"FW", report:"26 Jul 2026", src:"Nicolo Schira / Football365", tier:2, fee:"Undisclosed", truth:52, prob:30, light:"y", trend:"down", note:"Reported agreement in principle through 2027 with a 2028 option, but Trabzonspor have since tabled a rival offer and Salah is said to be leaning that way instead - a genuinely contested two-horse race."},
  {name:"Darwin Nunez", sub:"27 · FW · Uruguay", club:"Al-Hilal", pos:"FW", report:"3 Aug 2026", src:"Sacha Tavolieri / SportBible", tier:2, fee:"Loan", truth:50, prob:28, light:"o", trend:"flat", note:"Al-Hilal willing to loan Nunez out after a disappointing spell; now a four-way Süper Lig chase alongside Galatasaray, Fenerbahce and Trabzonspor rather than an exclusive Besiktas move."},
  {name:"Mauro Icardi", sub:"33 · FW · Argentina", club:"Free agent (ex-Galatasaray)", pos:"FW", report:"3 Aug 2026", src:"Fotomac", tier:3, fee:"Free", truth:25, prob:10, light:"r", trend:"down", note:"Besiktas management have explicitly denied any interest; his agent says he wants to stay in Europe. Included as a live but low-credibility line, not a genuine pursuit."},
  {name:"Dusan Vlahovic", sub:"26 · FW · Serbia", club:"Juventus", pos:"FW", report:"31 Jul 2026", src:"SPORT (via Derick Kinoti)", tier:3, fee:"Undisclosed", truth:30, prob:12, light:"r", trend:"flat", note:"Besiktas reportedly offered an improved two-year deal, but Vlahovic is said to be fixated on a move to Barcelona instead."}
];
const OUTGOING = [];
const RISERS = [];
const FALLERS = [];
