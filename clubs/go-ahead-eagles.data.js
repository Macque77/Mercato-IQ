...
const OUTGOING = [
  {name:"Calvin Twigt", sub:"Central midfielder", club:"Willem II", pos:"MF", report:"Newly-promoted Willem II raised their bid for the 22-year-old midfielder after an initial offer was rejected, but Go Ahead Eagles is holding firm and refusing to sell. Twigt impressed on loan at Willem II over the winter but is currently working back from injury.", src:"Rob Aarts & Sander Janssen, VI.nl", tier:1, fee:"Undisclosed", truth:75, prob:30, light:"y", trend:"flat", note:"Two years remaining on his Go Ahead contract; club under no pressure to sell."},
