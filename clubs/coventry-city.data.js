...
const INCOMING = [
  ...
  {name:"Caleb Yirenkyi", sub:"20 · Ghana · Forward", club:"Nordsjælland", pos:"F", report:"Coventry City have agreed a deal with Nordsjælland for Caleb Yirenkyi", src:"Coventry Telegraph", tier:2, fee:"£25.7m", truth:95, prob:95, light:"g", trend:"flat", note:"Deal agreed and announced", lastSeen:"2026-08-08T04:21:31Z", baseProb:95, dead:true, deadReason:"Deal completed and announced per headline; should be in confirmed_in but full name/details not provided in snippet text"},
...
const OUTGOING = [
  ...
  {name:"Gustavo Hamer", sub:"Unknown · Unknown · Midfielder", club:"Coventry City", pos:"Midfielder", report:"Coventry City see latest bid for Gustavo Hamer rejected by Sheffield United; deal 'off' with £8.5m offer rejected", src:"The Coventry Observer / BBC", tier:2, fee:"£8.5m (rejected)", truth:85, prob:60, light:"g", trend:"down", note:"Sheffield United rejected latest bid; gap in valuation exists but talks ongoing", lastSeen:"2026-08-08T07:40:33Z", baseProb:60}
];
const DEAD = [
...
const LINKMAP = {
  ...
  "Caleb Yirenkyi": ["coventryLiveCalebYirenkyi", "coventryTelegraphCalebYirenkyi", "coventryTelegraphCalebYirenkyi1", "coventryTelegraphCalebYirenkyi2", "coventryTelegraphCalebYirenkyi3", "coventryTelegraphCalebYirenkyi4"],
  ...
  "Gustavo Hamer": ["coventryObserverGustavoHamer", "bBCGustavoHamer", "coventryObserverGustavoHamer1", "coventryObserverGustavoHamer2", "theCoventryObserverGustavoHamer"],
