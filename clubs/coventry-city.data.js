...
const INCOMING = [
  ...
  {name:"Caleb Yirenkyi", sub:"20 · Ghana · F", club:"Nordsjaelland", pos:"F", report:"Coventry City have agreed a deal with Nordsjaelland to sign World Cup star Caleb Yirenkyi", src:"Coventry Telegraph", tier:3, fee:"Undisclosed", truth:95, prob:95, light:"g", trend:"flat", note:"Deal completed and announced", lastSeen:"2026-08-07T23:07:30Z", baseProb:95},
...
const OUTGOING = [
  ...
  {name:"Gustavo Hamer", sub:"25 · Netherlands · M", club:"Sheffield United", pos:"M", report:"Sheffield United have rejected Coventry City's latest bid for Gustavo Hamer; deal off", src:"Coventry Observer / Coventry Telegraph", tier:3, fee:"£8.5m", truth:85, prob:15, light:"o", trend:"down", note:"Latest Coventry bid rejected; transfer unlikely", lastSeen:"2026-08-07T23:07:30Z", baseProb:15}
];
const DEAD = [
...
const LINKMAP = {
  ...
  "Caleb Yirenkyi": ["coventryLiveCalebYirenkyi", "coventryTelegraphCalebYirenkyi", "coventryTelegraphCalebYirenkyi1", "coventryTelegraphCalebYirenkyi2", "coventryTelegraphCalebYirenkyi3"],
  "Carl Rushworth": ["coventryLiveCalebYirenkyi", "coventryCityFootballClubCarlRushworth", "coventryCityFootballClubCarlRushworth1", "coventryCityFootballClubCarlRushworth2"],
  "Gustavo Hamer": ["coventryObserverGustavoHamer", "bBCGustavoHamer", "coventryObserverGustavoHamer1"]};
const WL_LINKMAP = {
