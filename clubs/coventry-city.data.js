...
const INCOMING = [
  ...
  {name:"Caleb Yirenkyi", sub:"20 · Ghana · Forward", club:"Nordsjælland", pos:"F", report:"Coventry City have agreed a deal with Nordsjælland for Caleb Yirenkyi", src:"Coventry Telegraph", tier:2, fee:"£25.7m", truth:95, prob:95, light:"g", trend:"flat", note:"Deal agreed and announced", lastSeen:"2026-08-08T04:21:31Z", baseProb:95},
...
const OUTGOING = [
  ...
  {name:"Gustavo Hamer", sub:"25 · Netherlands · Midfielder", club:"Coventry City", pos:"M", report:"Sheffield United have rejected Coventry City's latest bid for Gustavo Hamer; talks continuing", src:"Coventry Observer / BBC", tier:2, fee:"£8.5m", truth:85, prob:70, light:"g", trend:"up", note:"Multiple bids rejected by Sheffield United; negotiations ongoing but uncertain", lastSeen:"2026-08-08T04:21:31Z", baseProb:70}
];
const DEAD = [
...
const LINKMAP = {
  ...
  "Gustavo Hamer": ["coventryObserverGustavoHamer", "bBCGustavoHamer", "coventryObserverGustavoHamer1", "coventryObserverGustavoHamer2"]};
const WL_LINKMAP = {
