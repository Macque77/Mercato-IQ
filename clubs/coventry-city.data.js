...
const INCOMING = [
  ...
  {name:"Caleb Yirenkyi", sub:"20 · Ghana · F", club:"Nordsjaelland", pos:"Forward", report:"Coventry City have agreed a deal with Nordsjaelland to sign World Cup star Caleb Yirenkyi; described as club-record transfer", src:"Coventry Telegraph", tier:3, fee:"£25.7m", truth:95, prob:95, light:"g", trend:"down", note:"Agreement reached; World Cup player", lastSeen:"2026-08-07T17:40:24Z", baseProb:95},
...
const OUTGOING = [
  ...
  {name:"Gustavo Hamer", sub:"28 · Netherlands · M", club:"Coventry City", pos:"Midfielder", report:"Sheffield United have rejected Coventry's latest bid for Gustavo Hamer; £8.5m deal previously mentioned as off", src:"BBC / Coventry Observer", tier:2, fee:"Undisclosed", truth:75, prob:60, light:"g", trend:"flat", note:"Bid rejected; interest from Sheffield United", lastSeen:"2026-08-07T17:40:24Z", baseProb:60}
];
const DEAD = [
...
const LINKMAP = {
  ...
  "Caleb Yirenkyi": ["coventryLiveCalebYirenkyi", "coventryTelegraphCalebYirenkyi", "coventryTelegraphCalebYirenkyi1", "coventryTelegraphCalebYirenkyi2"],
  "Carl Rushworth": ["coventryLiveCalebYirenkyi", "coventryCityFootballClubCarlRushworth", "coventryCityFootballClubCarlRushworth1"],
  "Gustavo Hamer": ["coventryObserverGustavoHamer", "bBCGustavoHamer"]};
const WL_LINKMAP = {
