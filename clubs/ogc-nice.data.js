...
const OUTGOING = [
  ...
  {name:"Kojo Peprah Oppong", sub:"Centre-back, Premier League interest", club:"Burnley", pos:"CB", report:"Burnley have registered interest in Nice centre-back Kojo Peprah Oppong as they look to bolster their defensive options following promotion.", src:"L'Equipe", tier:2, fee:"Undisclosed", truth:55, prob:35, light:"y", trend:"flat", note:"Described as growing interest rather than a concrete approach."},
  {name:"Kevin Carlos", sub:"Forward, loan option", club:"Samsunspor", pos:"ST", report:"Samsunspor are targeting Nice forward Kevin Carlos via a loan-with-option-to-buy structure as he looks for regular game time.", src:"L'Equipe", tier:2, fee:"Loan + option", truth:55, prob:40, light:"y", trend:"flat", note:"Structure reported as loan with option to buy rather than permanent sale."},
  {name:"James Tavernier", sub:"Defender, veteran free-agent option", club:"Rangers", pos:"RB", report:"Rangers captain James Tavernier is being courted by both Nice and Paris FC as a possible experienced addition at right-back.", src:"Foot Mercato", tier:2, fee:"Free transfer", truth:55, prob:30, light:"y", trend:"flat", note:"Same player linked to two of the tracked Ligue 1 clubs simultaneously, indicating early speculative interest."}
];
...
const LINKMAP = {
  ...
  "Kevin Carlos": ["gffn-nice", "getFrenchFootballNewsLEquipeKevinCarlos"],
