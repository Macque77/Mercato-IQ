...
const INCOMING = [
  ...
  {name:"Fedde Leysen", sub:"unknown · unknown · unknown", club:"PSV", pos:"unknown", report:"Transfer from PSV to Union Saint-Gilloise confirmed", src:"PSV official", tier:2, fee:"unknown", truth:100, prob:100, light:"g", trend:"flat", note:"Official confirmation from PSV", lastSeen:"2026-08-07T06:16:28Z", baseProb:100}
];
const OUTGOING = [
  ...
  {name:"Sadiki", sub:"unknown · unknown · unknown", club:"Union Saint-Gilloise", pos:"unknown", report:"Player departure confirmed; player statement released", src:"VoetbalPrimeur", tier:3, fee:"unknown", truth:100, prob:100, light:"g", trend:"flat", note:"Official departure confirmed with player farewell statement", lastSeen:"2026-08-07T06:16:28Z", baseProb:100}
];
const RISERS = [];
const FALLERS = [];
const NEW = [];
