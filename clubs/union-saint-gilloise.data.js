...
const INCOMING = [
  ...
  {name:"Fedde Leysen", sub:"unknown · Netherlands · unknown", club:"PSV", pos:"unknown", report:"Transfer from PSV confirmed", src:"PSV official", tier:2, fee:"unknown", truth:100, prob:100, light:"g", trend:"flat", note:"Official transfer completed", lastSeen:"2026-08-07T01:42:32Z", baseProb:100}
];
const OUTGOING = [
  ...
  {name:"Sadiki", sub:"unknown · unknown · unknown", club:"Union Saint-Gilloise", pos:"unknown", report:"Player departure confirmed", src:"VoetbalPrimeur.be", tier:3, fee:"unknown", truth:100, prob:100, light:"g", trend:"flat", note:"Official departure statement", lastSeen:"2026-08-07T01:42:32Z", baseProb:100}
];
const RISERS = [];
const FALLERS = [];
const NEW = [];
