...
const OUTGOING = [
  {name:"Fisnik Asllani", sub:"23 · Kosovo · ST", club:"RB Leipzig", pos:"Striker", report:"Sport BILD say the Kosovo international has chosen Leipzig ahead of Barcelona and that a move is imminent, with Leipzig intending to activate the release clause in his Hoffenheim contract. Salary terms with the player were still to be agreed.", src:"Sport BILD", tier:2, fee:"Release clause", truth:80, prob:75, light:"g", trend:"up", note:"Single-source tabloid reporting and personal terms were unresolved when it broke, so the deal is close rather than done. No confirmation yet from Hoffenheim or Leipzig.", lastSeen:"2026-08-06T10:49:40Z", baseProb:75}
];
