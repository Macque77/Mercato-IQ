...
const INCOMING = [
  ...
  {name:"Lukas Mondele", sub:"Unknown · Belgium · Midfielder", club:"Francs Borains", pos:"Midfielder", report:"Transfer from Francs Borains to Cercle Brugge confirmed by manager Maarten Martens", src:"hbvl.be", tier:3, fee:"Unknown", truth:75, prob:85, light:"g", trend:"flat", note:"Belgian midfielder joining as springboard transfer after Francs Borains", lastSeen:"2026-08-07T14:38:27Z", baseProb:85}
];
const OUTGOING = [
  ...
  {name:"Ayase Ueda", sub:"Unknown · Japan · Forward", club:"Cercle Brugge", pos:"Forward", report:"Ayase Ueda transferred to Premier League; Cercle Brugge receives bonus", src:"VoetbalBelgie", tier:3, fee:"Unknown", truth:80, prob:90, light:"g", trend:"flat", note:"Departure to Premier League with financial benefit to Cercle Brugge", lastSeen:"2026-08-07T14:38:27Z", baseProb:90},
  {name:"Warleson", sub:"Unknown · Brazil · Unknown", club:"Cercle Brugge", pos:"Unknown", report:"Cercle Brugge facing emotional decision as Warleson departs to Brazil", src:"VoetbalFocus", tier:3, fee:"Unknown", truth:70, prob:75, light:"g", trend:"flat", note:"Brazilian player expected to leave for Brazil; emotional decision for club", lastSeen:"2026-08-07T14:38:27Z", baseProb:75}
];
const RISERS = [];
const FALLERS = [];
const NEW = [];
...
const LINKMAP = {
  ...
  "Lukas Mondele": ["voetbalkrantGaetanCoucke", "hbvlbeLukasMondele"],
  ...
  "Abdoulie Manneh": ["voetbalPrimeurbeAbdoulieManneh"]};
const WL_LINKMAP = {};
