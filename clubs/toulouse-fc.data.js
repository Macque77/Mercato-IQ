...
const INCOMING = [
  {name:"Gift Orban", sub:"Nigerian striker resurfaces as a cut-price target", club:"Olympique Lyonnais", pos:"ST", report:"Toulouse are ready to move for the Lyon flop at a reduced price, almost a year after a move nearly happened in the previous summer window before collapsing.", src:"MSN Sport", tier:3, fee:"Undisclosed (reduced price)", truth:40, prob:30, light:"y", trend:"flat", note:"Previous transfer attempt fell through last summer; Orban has struggled for minutes at Lyon since.", lastSeen:"2026-08-04T19:10:50Z", baseProb:30}
];

const OUTGOING = [
  {name:"Guillaume Restes", sub:"22 · GK · France", club:"Marseille / Aston Villa (competing)", pos:"GK", report:"30 Jul 2026", src:"Get French Football News", tier:2, fee:"TBD", truth:52, prob:26, light:"o", trend:"flat", note:"Marseille and Aston Villa are both reported to be competing for the young goalkeeper.", lastSeen:"2026-08-04T19:10:50Z", baseProb:26},
  {name:"Cristian Casseres Jr.", sub:"Venezuelan midfielder wanted by multiple suitors", club:"Olympique Lyonnais / RC Lens", pos:"CDM", report:"Lyon are reportedly trying to beat Lens to the signature of the Toulouse midfielder, the latest twist after Sevilla had an earlier bid rejected and Genoa also showed renewed Serie A interest.", src:"Les Transferts (via Nova Sports)", tier:3, fee:"Undisclosed", truth:45, prob:30, light:"y", trend:"flat", note:"Casseres is under contract to 2027; Toulouse have previously rejected a Sevilla bid and fought off Genoa interest, but Ligue 1 rivals Lyon and Lens are now competing for him.", lastSeen:"2026-08-04T19:10:50Z", baseProb:30},
  {name:"Yann Gboho", sub:"Ivorian winger drawing foreign interest", club:"Unnamed English club", pos:"LW", report:"An English club has reportedly positioned itself for Ligue 1's top dribbler this summer, after an unnamed Italian side previously showed winter interest.", src:"MSN Sport", tier:3, fee:"Undisclosed", truth:35, prob:20, light:"o", trend:"flat", note:"No club has been formally named; Gboho joined Toulouse from Cercle Bruges in January 2024 for around €2.5m.", lastSeen:"2026-08-04T19:10:50Z", baseProb:20}
];
