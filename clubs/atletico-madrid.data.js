...
const INCOMING = [
  ...
  {name:"Cristian Romero", sub:"28 · Argentina · CB", club:"Tottenham Hotspur", pos:"CB", report:"Atlético are preparing a bid for Romero, to be submitted once they complete outgoings. Romano said on Wednesday that the offer follows the next sales, Molina and possibly Ruggeri.", src:"Fabrizio Romano", tier:1, fee:"Undisclosed", truth:78, prob:40, light:"y", trend:"flat", note:"No bid has been lodged yet and the whole move is funded by sales that are not finished. Tottenham's asking price and willingness to sell are not established in the reporting.", lastSeen:"2026-08-06T10:49:40Z", baseProb:40}
];
...
const OUTGOING = [
  ...
  {name:"Nahuel Molina", sub:"28 · Argentina · RB", club:"Unspecified", pos:"RB", report:"Molina is earmarked for sale, with Romano describing the Romero bid as coming after the next sales of Molina and possibly Ruggeri.", src:"Fabrizio Romano", tier:1, fee:"Undisclosed", truth:70, prob:55, light:"g", trend:"flat", note:"Club intent rather than an agreed transfer: no buying club is named in the reporting, so do not attach a destination.", lastSeen:"2026-08-06T10:49:40Z", baseProb:55},
  ...
  {name:"Matteo Ruggeri", sub:"24 · Italy · LB", club:"Aston Villa", pos:"LB", report:"Villa have struck an agreement for the left-back, who made 47 appearances and registered seven assists for Atlético. The sale is part of the funding for Atlético's push for a new centre-back.", src:"Fabrizio Romano", tier:1, fee:"Undisclosed", truth:80, prob:72, light:"g", trend:"flat", note:"Agreement reported at club level; no fee has been confirmed and the deal was relayed second hand rather than via a primary link.", lastSeen:"2026-08-06T10:49:40Z", baseProb:72}
];
...
const HUB = {
  ...
  tEAMtalkrelayingFabrizioRomanoCristianRomero: {l:"TEAMtalk (relaying Fabrizio Romano)", u:"https://www.teamtalk.com/aston-villa/aston-villa-reach-agreement-atletico-madrid-liverpool-tottenham-target-fifth-signing"}};
...
const LINKMAP = {
  ...
  "Nahuel Molina": ["estoEsAtletiNahuelMolina", "tEAMtalkrelayingFabrizioRomanoCristianRomero"],
  ...
  "Cristian Romero": ["tEAMtalkrelayingFabrizioRomanoCristianRomero"],
  "Matteo Ruggeri": ["tEAMtalkrelayingFabrizioRomanoCristianRomero"]};
const WL_LINKMAP = {};
