...
const OUTGOING = [
  ...
  {name:"Isaac Price", sub:"Unknown · Unknown · Unknown", club:"West Bromwich Albion", pos:"Unknown", report:"Everton target in return bid", src:"SportsBoom UK", tier:3, fee:"Unknown", truth:35, prob:30, light:"y", trend:"flat", note:"Everton linked with a move", lastSeen:"2026-08-07T01:42:32Z", baseProb:30}
];
const RISERS = [];
const FALLERS = [];
const NEW = [];
...
const LINKMAP = {
  ...
  "Jimmy-Jay Morgan": ["weAintGotNoHistoryJimmyJayMorgan"],
