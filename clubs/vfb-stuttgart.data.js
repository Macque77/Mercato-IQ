...
const INCOMING = [
  {name:"Dzenan Pejcinovic", sub:"Striker linked as Stuttgart chase attacking reinforcement", club:"VfL Wolfsburg", pos:"ST", report:"Stuttgart are locked in 'difficult' talks with Wolfsburg for the 21-year-old striker, who scored 12 goals last season, but the two clubs remain far apart on valuation.", src:"Goal.com (Christian Guinin)", tier:1, fee:"Wolfsburg want €25m+, Stuttgart yet to match", truth:75, prob:45, light:"y", trend:"flat", note:"Sporting director Fabian Wohlgemuth confirmed talks are ongoing but said a deal is 'a long way off'; Wolfsburg under no financial pressure to sell after the €17m Koulierakis sale to Roma."},
  {name:"Radek Vitek", sub:"Goalkeeper eyed amid Stuttgart injury crisis", club:"Manchester United", pos:"GK", report:"Stuttgart are exploring a move for the uncapped Manchester United goalkeeper after Alexander Nübel's understudy Dennis Seimen was ruled out for at least two months.", src:"Bild", tier:2, fee:"Valued around €6m (Transfermarkt)", truth:65, prob:40, light:"y", trend:"flat", note:"Vitek, 22, has made no senior United appearances but impressed on loan at Bristol City (41 apps); Hull City and Celtic are also credited with interest."}
];
...
const OUTGOING = [
  ...
  {name:"Ermedin Demirovic", sub:"Bosnian striker admired by Leeds United", club:"Leeds United", pos:"ST", report:"Leeds United have identified Demirovic as an attacking target for Daniel Farke's Premier League survival push, but the striker is reportedly content in Stuttgart.", src:"Slobodna Bosna", tier:2, fee:"Not specified", truth:55, prob:25, light:"o", trend:"flat", note:"Demirovic contributed to 20 goals last season and is not pushing for an exit, giving Stuttgart a strong negotiating position; other unnamed European clubs are also monitoring him."},
  {name:"Alexander Nübel", sub:"Number one goalkeeper drawing Turkish interest", club:"Besiktas", pos:"GK", report:"Besiktas have been credited with surprise interest in Nübel as they look to strengthen their goalkeeping options this summer.", src:"A Spor", tier:2, fee:"Not specified", truth:55, prob:30, light:"y", trend:"flat", note:"Reported as part of a wider look at Besiktas's defensive and goalkeeping targets from the Bundesliga."},
  {name:"Jeff Chabot", sub:"Defender floated as alternative Besiktas target", club:"Besiktas", pos:"CB", report:"Besiktas are said to view the 23-year-old Chabot as a defensive alternative after missing out on their primary target, Flamengo's Leo Pereira.", src:"A Spor", tier:3, fee:"Not specified", truth:45, prob:20, light:"o", trend:"flat", note:"Chabot is under contract at Stuttgart until 2028 and remains a key player under Sebastian Hoeneß, making a move unlikely without a significant offer."}
];
