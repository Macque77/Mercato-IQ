...
const CONFIRMED_OUT = [
  {name:"Carlos Espí", sub:"Forward", club:"Real Madrid", pos:"FW", fee:"€25m (release clause)", free:false, status:"done", statusTxt:"DONE, OFFICIAL", note:"Mourinho personally requested the deal for the breakout striker, whose rapid rise forced a quick release-clause transfer."}
];
...
const LINKMAP = {
  ...
  "Yanis Musuayi": ["elGolDigitalYanisMusuayi"],
