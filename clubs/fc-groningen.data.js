...
const INCOMING = [
  {name:"Malcolm Jeng", sub:"young midfielder", club:"Feyenoord (loan)", pos:"MF", report:"FC Groningen are seeking to bring Jeng in on loan; some reports instead link his parent club as Stade Reims with a loan-plus-purchase-option structure.", src:"FCUpdate.nl", tier:2, fee:"Loan", truth:40, prob:35, light:"y", trend:"flat", note:"Conflicting reports on parent club (Feyenoord vs. Stade Reims) — treat with caution.", lastSeen:"2026-08-04T19:10:50Z", baseProb:35},
  {name:"Travis Hernes", sub:"midfielder, currently on loan at Groningen", club:"Newcastle United (England)", pos:"MF", report:"Groningen are reviewing an option to make Hernes's loan spell permanent through to mid-2030; described in some outlets as already a 'loan return' but the buy option is still under review.", src:"VI.nl", tier:2, fee:"Undisclosed (option to buy)", truth:55, prob:55, light:"g", trend:"flat", note:"", lastSeen:"2026-08-04T19:10:50Z", baseProb:55},
  {name:"Marley Dors", sub:"20, forward, emerging talent", club:"Almere City", pos:"FW", report:"Named as a young target for Groningen; under contract at Almere City through mid-2027.", src:"FCUpdate.nl", tier:2, fee:"Undisclosed", truth:40, prob:20, light:"o", trend:"flat", note:"", lastSeen:"2026-08-04T19:10:50Z", baseProb:20},
  {name:"Mikkel Desler", sub:"defender", club:"Unspecified current club", pos:"DF", report:"Reported as in negotiations with Groningen, per Dutch aggregator coverage citing VI.nl/Voetbalprimeur.", src:"Nieuwsbreak.nl (via VI.nl/Voetbalprimeur)", tier:3, fee:"Undisclosed", truth:30, prob:20, light:"o", trend:"flat", note:"Low-confidence aggregator report; player's current club unclear from available sourcing.", lastSeen:"2026-08-04T19:10:50Z", baseProb:20}
];

const OUTGOING = [
  {name:"Thom van Bergen", sub:"forward, Jong Oranje international", club:"AZ Alkmaar", pos:"FW", report:"AZ have reportedly made multiple bids (€5m+) for Van Bergen, but Groningen are holding firm on their valuation; player is under contract to 2028.", src:"Transfernieuws.nl", tier:2, fee:"€5m+ (bid, rejected)", truth:55, prob:35, light:"y", trend:"flat", note:"", lastSeen:"2026-08-04T19:10:50Z", baseProb:35}
];
