...
const INCOMING = [
  ...
  {name:"Eli Junior Kroupi", sub:"Forward, French, 20", club:"Bournemouth", pos:"ST", report:"Barcelona have identified the Bournemouth forward as a backup/Plan B striker target amid their pursuit of a marquee No.9, though he also draws interest from Manchester City, PSG, Arsenal and Tottenham.", src:"Multiple aggregated reports", tier:3, fee:"", truth:40, prob:15, light:"o", trend:"flat", note:"Reports indicate an injury setback has complicated this route, and heavy competition from richer Premier League/PSG suitors makes a Barça move unlikely without Álvarez falling through entirely."}
];

const OUTGOING = [
  {name:"Ferran Torres", sub:"26 · RW/LW · Spain", club:"Real Madrid / PSG (interest)", pos:"RW/LW", report:"03 Aug 2026", src:"Barca Blaugranes", tier:2, fee:"Speculative", truth:40, prob:15, light:"o", trend:"down", note:"CORRECTED 03 Aug: an earlier version of this record wrongly logged a completed €55m Torres sale to Real Madrid - that never happened. As of 3 August, Barcelona's own line is that Torres is 'not for sale', even as PSG and Madrid are credited with background interest. Treat as live speculation only."}
];
...
const LINKMAP = {
  ...
  "Ferran Torres": ["barcablaugranes-3aug", "mSNForbesFerranTorres"],
