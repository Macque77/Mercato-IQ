...
const INCOMING = [
  ...
  {name:"Vinícius Gabias", sub:"20 · CM · Brazil", club:"Flamengo", pos:"CM", report:"28 Jul 2026", src:"Fabrizio Romano", tier:1, fee:"€18m", truth:75, prob:68, light:"g", trend:"up", note:"Brazilian prospect attracting serious interest; negotiations ongoing with Rio club."},
...
const HUB = {
  "gnews-robertlewandowski": {l:"Related news search: Robert Lewandowski", u:"https://news.google.com/search?q=FC%20Barcelona%20Robert%20Lewandowski%20transfer&hl=en-GB&gl=GB"},
  "gnews-ferrantorres": {l:"Related news search: Ferran Torres", u:"https://news.google.com/search?q=FC%20Barcelona%20Ferran%20Torres%20transfer&hl=en-GB&gl=GB"},
  "gromero": {l:"Gerard Romero", u:"https://x.com/gerardromero"},
  "romano": {l:"Fabrizio Romano", u:"https://x.com/FabrizioRomano"},
  "gnews-ederson": {l:"Related news search: Ederson", u:"https://news.google.com/search?q=FC%20Barcelona%20Ederson%20transfer&hl=en-GB&gl=GB"},
  "gnews-sergiodest": {l:"Related news search: Sergiño Dest", u:"https://news.google.com/search?q=FC%20Barcelona%20Sergi%C3%B1o%20Dest%20transfer&hl=en-GB&gl=GB"},
  "gnews-vinciusgabias": {l:"Related news search: Vinícius Gabias", u:"https://news.google.com/search?q=FC%20Barcelona%20Vin%C3%ADcius%20Gabias%20transfer&hl=en-GB&gl=GB"}
};

const LINKMAP = {
  "Robert Lewandowski": ["gnews-robertlewandowski"],
  "Ferran Torres": ["gnews-ferrantorres"],
  "Sergiño Dest": ["gromero"],
  "Vinícius Gabias": ["romano"],
  "Ederson": ["gnews-ederson"]
};
const WL_LINKMAP = {
  "Sergiño Dest": ["gnews-sergiodest"],
  "Vinícius Gabias": ["gnews-vinciusgabias"]
};
