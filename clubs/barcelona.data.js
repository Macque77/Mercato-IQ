...
const INCOMING = [
  {name:"Rodri", sub:"28 · Spain · Midfielder", club:"Manchester City", pos:"Midfielder", report:"Barcelona keen on Rodri as Real Madrid talks stall; among clubs monitoring the City star", src:"BBC Sport, The Guardian", tier:2, fee:"Undisclosed", truth:65, prob:45, light:"y", trend:"up", note:"Real Madrid talks with Manchester City have stalled; Barcelona among interested parties", lastSeen:"2026-08-06T14:21:37Z", baseProb:45}
];

const OUTGOING = [
  {name:"Ferran Torres", sub:"24 · Spain · Winger", club:"Barcelona", pos:"Winger", report:"Barcelona told PSG that Ferran Torres is not for sale; World Cup hero facing decision on future", src:"BBC Sport, Mundo Deportivo", tier:2, fee:"Undisclosed", truth:70, prob:55, light:"g", trend:"up", note:"Barcelona have rejected PSG interest; Torres uncertain about his future at the club", lastSeen:"2026-08-06T14:21:37Z", baseProb:55}
];
const DEAD = [
  {name:"Julián Álvarez", sub:"Striker, Argentine, 26", club:"Atlético Madrid", pos:"ST", report:"Barcelona are pursuing Álvarez as their primary striker target following Lewandowski's exit, with the player publicly stating his desire to join; Atlético are resisting and Barça's reported offers (~€100m) remain below Atlético's demands.", src:"Multiple (Goal.com, Yahoo Sports, La Gaceta)", tier:2, fee:"", truth:70, prob:35, light:"y", trend:"flat", note:"Álvarez's representatives were reported to be meeting with Barcelona to plan a joint strategy, and Barça were said to be preparing a new bid; deal complicated by Atlético's refusal to sell to a domestic rival and the window closing 1 Sept.", lastSeen:"2026-08-04T19:10:50Z", baseProb:35, dead:true, deadReason:"Multiple duplicate entries on page (Julian Alvarez / Julián Álvarez); no fresh snippet support; likely stale rumour", dir:"in", deadAt:"2026-08-06T14:21:38Z"},
  {name:"Eli Junior Kroupi", sub:"Forward, French, 20", club:"Bournemouth", pos:"ST", report:"Barcelona have identified the Bournemouth forward as a backup/Plan B striker target amid their pursuit of a marquee No.9, though he also draws interest from Manchester City, PSG, Arsenal and Tottenham.", src:"Multiple aggregated reports", tier:3, fee:"", truth:40, prob:15, light:"o", trend:"flat", note:"Reports indicate an injury setback has complicated this route, and heavy competition from richer Premier League/PSG suitors makes a Barça move unlikely without Álvarez falling through entirely.", lastSeen:"2026-08-04T19:10:50Z", baseProb:15, dead:true, deadReason:"No fresh snippet support; entry appears outdated", dir:"in", deadAt:"2026-08-06T14:21:38Z"},
  {name:"João Cancelo", sub:"30 · Portugal · Defender", club:"Barcelona", pos:"Defender", report:"Stand-off between Barcelona and interested clubs over João Cancelo", src:"Mundo Deportivo", tier:3, fee:"Around 10m euros", truth:50, prob:40, light:"y", trend:"down", note:"Ongoing stand-off; details unclear", lastSeen:"2026-08-06T14:21:37Z", baseProb:40, dir:"out", deadReason:"completed move to barcelona", deadAt:"2026-08-06T14:21:38Z"}
];
...
const HUB = {
  ...
  bBCSportFootballRodri: {l:"BBC Sport Football", u:"https://www.bbc.co.uk/sport/football/articles/cglj6p6n9l8o"},
  bBCSportFootballFerranTorres: {l:"BBC Sport Football", u:"https://www.bbc.co.uk/sport/football/articles/cx2r5v3ykjyo"}};
...
const LINKMAP = {
  ...
  "Ferran Torres": ["barcablaugranes-3aug", "mSNForbesFerranTorres", "mundoDeportivoviaBarcaBlaugranesFerranTorres", "bBCSportFootballFerranTorres"],
  ...
  "Rodri": ["fabrizioRomanoXKarimAdeyemi", "bBCSportFootballRodri"]};
const WL_LINKMAP = {
