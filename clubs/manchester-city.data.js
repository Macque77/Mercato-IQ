...
const INCOMING = [
  {name:"Elliot Anderson", sub:"21 · England · M", club:"Nottingham Forest", pos:"M", report:"Agreement reached after improved offer to Nottingham Forest", src:"David Ornstein", tier:1, fee:"£106m plus add-ons", truth:95, prob:90, light:"g", trend:"up", note:"Verbal offer made; deal described as 'agreement' by Ornstein", lastSeen:"2026-08-08T10:03:40Z", baseProb:90},
  {name:"James Trafford", sub:"22 · England · GK", club:"Leeds United", pos:"GK", report:"Leeds in talks with Manchester City over goalkeeper", src:"David Ornstein", tier:1, fee:"Undisclosed", truth:75, prob:65, light:"g", trend:"down", note:"Early-stage discussions reported", lastSeen:"2026-08-08T10:03:40Z", baseProb:65}
];
const OUTGOING = [
  {name:"Rodri", sub:"28 · Spain · M", club:"Real Madrid", pos:"M", report:"Real Madrid working on deal; Barcelona made €45m offer which City refused as unserious", src:"David Ornstein", tier:1, fee:"€45m (Barcelona bid, rejected)", truth:80, prob:75, light:"g", trend:"flat", note:"Deal described as 'very close'; Man City have set a price; Barcelona's €45m bid rejected", lastSeen:"2026-08-08T10:03:40Z", baseProb:75}
];
const DEAD = [
