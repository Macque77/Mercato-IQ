...
const INCOMING = [
  {name:"Elliot Anderson", sub:"21 · England · M", club:"Nottingham Forest", pos:"M", report:"Agreement reached after improved offer to Nottingham Forest; Manchester City made £106m plus add-ons verbal offer", src:"David Ornstein", tier:1, fee:"£106m plus add-ons", truth:95, prob:85, light:"g", trend:"up", note:"Deal described as 'agreement' after improved offer; verbal offer confirmed", lastSeen:"2026-08-08T07:40:33Z", baseProb:85},
  {name:"James Trafford", sub:"22 · England · GK", club:"Leeds United", pos:"GK", report:"Leeds in talks with Manchester City over goalkeeper", src:"David Ornstein", tier:1, fee:"Undisclosed", truth:75, prob:70, light:"g", trend:"flat", note:"Talks ongoing between Leeds and Manchester City", lastSeen:"2026-08-08T07:40:33Z", baseProb:70}
];
const OUTGOING = [
  {name:"Rodri", sub:"28 · Spain · M", club:"Real Madrid", pos:"M", report:"Real Madrid working on deal; Barcelona made €45m offer which Manchester City refuse to engage with as 'unserious'; Ornstein reveals Man City's set price as 'deal very close' for replacement", src:"David Ornstein", tier:1, fee:"€45m (Barcelona bid, rejected)", truth:85, prob:75, light:"g", trend:"up", note:"Real Madrid actively pursuing; Barcelona's €45m bid rejected as insufficient; City has set their price; deal described as 'very close'", lastSeen:"2026-08-08T07:40:33Z", baseProb:75}
];
const DEAD = [
