...
const INCOMING = [];
const OUTGOING = [
  {name:"Rodri", sub:"28 · Spain · M", club:"Manchester City", pos:"Midfielder", report:"Barcelona keen on Rodri as Real Madrid talks with Manchester City star stall", src:"The Guardian", tier:2, fee:"Undisclosed", truth:75, prob:35, light:"y", trend:"up", note:"Barcelona and Real Madrid both tracking; talks described as stalling", lastSeen:"2026-08-06T14:04:24Z", baseProb:35}
];
const DEAD = [
