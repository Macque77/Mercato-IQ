...
const INCOMING = [
  {name:"Rômulo Júnior", sub:"22 · CB · Brazil", club:"Atlético Mineiro", pos:"CB", report:"1 Jul 2026", src:"Gabriel Machado / Antena do Futebol (via A Bola, 26 Jun)", tier:3, fee:"Loan + €4m option (80% economic rights)", truth:72, prob:40, light:"y", trend:"flat", note:"Brazilian outlets said the loan was 'agreed' with a buy option in early July, but the 22-year-old centre-back was absent from Santa Clara's official 11-man reinforcement list unveiled on 1 August, suggesting the move has stalled or fallen through."},
