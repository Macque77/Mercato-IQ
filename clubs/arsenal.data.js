...
const INCOMING = [
  {name:"Bruno Guimarães", sub:"28 · Brazil · CM", club:"Newcastle United", pos:"CM", report:"Arsenal and Newcastle have agreed fee; player awaiting medical", src:"David Ornstein", tier:1, fee:"Undisclosed", truth:95, prob:90, light:"g", trend:"flat", note:"Near total agreement; medical stage", lastSeen:"2026-08-08T14:10:31Z", baseProb:90},
  {name:"Vinícius Júnior", sub:"24 · Brazil · LW", club:"Real Madrid", pos:"LW", report:"Arsenal exploring improved offer; agreement expected", src:"David Ornstein", tier:1, fee:"Undisclosed", truth:35, prob:25, light:"o", trend:"down", note:"Improved offer details revealed; speculative interest", lastSeen:"2026-08-08T14:10:31Z", baseProb:25}
];
...
const OUTGOING = [
  ...
  {name:"Christian Norgaard", sub:"29 · Denmark · CM", club:"Everton", pos:"CM", report:"Everton reach agreement in principle; £7m transfer", src:"David Ornstein", tier:1, fee:"£7m", truth:85, prob:80, light:"g", trend:"down", note:"Agreement in principle reached", lastSeen:"2026-08-08T14:10:31Z", baseProb:80}
];
const DEAD = [
...
const HUB = {
  ...
  bBCSportFootballBrunoGuimares: {l:"BBC Sport Football", u:"https://www.bbc.co.uk/sport/football/articles/clyl2e351vlo?at_medium=RSS&at_campaign=rss"},
  ...
  davidOrnsteinFootball365BrunoGuimares: {l:"David Ornstein / Football365", u:"https://news.google.com/rss/articles/CBMikgFBVV95cUxONGZWOFc3SnVFTE5PSEhEU05ZSkFReURMeVJVY2dacGZMcjhmTGctMDQxbnVmNklfdFZlanhYU0RvLS1USHFtVVVLWUNCS1hmQUxHcTVlOWpvbkFIQmlqNDA1UmdnZWtBckhlMVQzaElQaS1DM202TGo2eEtycGtVTWU0UDVfejExX2FyamNjSTZlZw"},
  davidOrnsteinTheAthleticVinciusJnior: {l:"David Ornstein / The Athletic", u:"https://news.google."},
  theAthleticBrunoGuimares: {l:"The Athletic", u:"https://news.google.com/rss/articles/CBMimwFBVV95cUxNTHZ3OE1vTmh1V3NsenI0T3E3MndfbW1zNG9RRFhJdV84UDJvZS1rUkpjb3NQQVdEc1BsNkRuMHcyNWtkWEJaZno3WW5GbmczZmFFOXRvUUlIdVFUbVpYMDBhYkJmbmhueTMwSFZMQTNrYm0tM0x4b3FUdXhqdWphZVhmelBNb3VCaE91UlplQW9pTGVKNmNEUGUwcw"},
  football365viaDavidOrnsteinVinciusJnior: {l:"Football365 via David Ornstein", u:"https://news.google."},
  davidOrnsteinTheAthleticVinciusJnior1: {l:"David Ornstein (The Athletic)", u:"https://news.google."}};
const LINKMAP = {
  ...
  "Bruno Guimarães": ["football365viaFabrizioRomanoBrunoGuimares", "skySportsBrunoGuimares", "theGuardianFootballBrunoGuimares", "bBCSportFootballBrunoGuimares", "theAthleticDavidOrnsteinBrunoGuimares", "davidOrnsteinTheAthleticBrunoGuimares", "davidOrnsteinFootball365BrunoGuimares", "theAthleticBrunoGuimares"],
  ...
  "Vinícius Júnior": ["theAthleticDavidOrnsteinVinciusJnior", "davidOrnsteinFootball365VinciusJnior", "davidOrnsteinTheAthleticVinciusJnior", "football365viaDavidOrnsteinVinciusJnior", "davidOrnsteinTheAthleticVinciusJnior1"]};
const WL_LINKMAP = {
