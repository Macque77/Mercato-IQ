...
const INCOMING = [
  {name:"Bruno Guimarães", sub:"28 · Brazil · CM", club:"Newcastle United", pos:"CM", report:"Arsenal and Newcastle have agreed fee (£75m); player awaiting medical", src:"David Ornstein", tier:1, fee:"£75m", truth:95, prob:95, light:"g", trend:"up", note:"Near total agreement reached; medical stage", lastSeen:"2026-08-08T18:06:10Z", baseProb:95},
  {name:"Vinícius Júnior", sub:"24 · Brazil · LW", club:"Real Madrid", pos:"LW", report:"Arsenal exploring improved offer; agreement expected", src:"David Ornstein", tier:1, fee:"Undisclosed", truth:60, prob:35, light:"y", trend:"down", note:"Arsenal working on move with improved offer details revealed", lastSeen:"2026-08-08T18:06:10Z", baseProb:35}
];
...
const OUTGOING = [
  ...
  {name:"Christian Norgaard", sub:"32 · Denmark · CM", club:"Everton", pos:"CM", report:"Everton reach agreement in principle; £7m transfer", src:"David Ornstein", tier:1, fee:"£7m", truth:90, prob:90, light:"g", trend:"up", note:"Agreement in principle reached with Everton", lastSeen:"2026-08-08T18:06:10Z", baseProb:90}
];
const DEAD = [
