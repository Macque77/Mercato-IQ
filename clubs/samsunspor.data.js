...
const HUB = {
  ...
  fotomacIgorDrapinski: {l:"Fotomac", u:"https://www.fotomac.com.tr/samsunspor/2026/08/06/samsunspor-igor-drapinskiyi-renklerine-katti"}};

const LINKMAP = {
  "Kevin Carlos": ["sporxKevinCarlos"],
  "Ali Diabaté": ["fotomaAliDiabat"],
  "Rick van Drongelen": ["fanatikRickvanDrongelen"],
  "Igor Drapinski": ["fotomacIgorDrapinski"]};
const WL_LINKMAP = {};
