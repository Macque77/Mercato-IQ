...
const SWEEP = {
  ...
  queries: ["real-sociedad transfer news"]
};
...
const HUB = {
  club: {l:"Real-Sociedad Official", u:"#"}
};
...
const PROSE = {
  heroH2: `Real Sociedad · 2026/27 Season`,
  heroLede: `Transfer window active. Real Sociedad preparing squad for next season.`,
