...
const INCOMING = [
  ...
  {name:"Nathan Zézé", sub:"21 · France · CB", club:"Nantes", pos:"Centre-back", report:"A second starting centre-back is the priority for Pellegrino Matarazzo and Zézé has emerged as a target as sporting director Erik Bretos works through his options.", src:"El Desmarque", tier:2, fee:"Undisclosed", truth:60, prob:30, light:"y", trend:"flat", note:"Nothing is close: El Desmarque describes a market moving slowly with no operation yet crystallised, and Ladislav Krejcí is listed alongside Zézé as an alternative. Treat as a shortlist name, not a deal.", lastSeen:"2026-08-06T10:49:40Z", baseProb:30}
];
...
const OUTGOING = [
  ...
  {name:"Javi López", sub:"Spain · LB", club:"Rayo Vallecano", pos:"Left-back", report:"The left-back is now the man pointed towards the exit, with Rayo Vallecano joining the list of suitors after a productive loan at Oviedo.", src:"Noticias de Gipuzkoa, via El Desmarque", tier:2, fee:"Undisclosed", truth:65, prob:45, light:"y", trend:"flat", note:"Regional Basque reporting rather than a tier-one break, and the Sociedad exit plan has already been rewritten once this window.", lastSeen:"2026-08-06T10:49:40Z", baseProb:45}
];
const DEAD = [];
...
const HUB = {
  ...
  elDesmarqueNathanZz: {l:"El Desmarque", u:"https://www.eldesmarque.com/futbol/mercado-de-fichajes/20260805/real-sociedad-mercado-fichajes-futuro-jon-martin-pellegrino-matarazzo-acepta_18_019887589.html"},
  elDesmarqueJaviLpez: {l:"El Desmarque", u:"https://www.eldesmarque.com/futbol/mercado-de-fichajes/20260803/real-sociedad-altera-plan-mercado-sustituye-operacion-decision-tomada_18_019878494.html"}};
...
const LINKMAP = {
  ...
  "Nathan Zézé": ["elDesmarqueNathanZz"],
  "Javi López": ["elDesmarqueJaviLpez"]};
const WL_LINKMAP = {
  "Arsen Zakharyan": ["futbolfantasy-realsociedad"]
};
