...
const OUTGOING = [
  ...
  {name:"Mikey Moore", sub:"unknown · unknown · unknown", club:"Köln", pos:"unknown", report:"Köln have sent an official bid", src:"unknown", tier:3, fee:"unknown", truth:60, prob:55, light:"g", trend:"flat", note:"Official bid received from Köln", lastSeen:"2026-08-08T16:04:57Z", baseProb:55},
  {name:"Manor Solomon", sub:"Unknown · Unknown · Unknown", club:"West Ham United", pos:"Unknown", report:"West Ham and Tottenham negotiations currently off", src:"David Ornstein", tier:1, fee:"Unknown", truth:65, prob:35, light:"y", trend:"down", note:"Talks stalled; move unlikely at present", lastSeen:"2026-08-08T07:40:33Z", baseProb:35, dead:true, deadReason:"Ornstein confirms West Ham–Tottenham negotiations are currently off"}
];
const DEAD = [
...
const WATCHLIST = [
  {name:"Martin Baturina", club:"Como", pos:"AM/W", dir:"in", age:"~3 wks", tier:3, note:"Como want €80m (£68m) and have already rejected a reported £47m bid from a Premier League club; parked as the luxury No.10/wide option behind the Savinho and Leão chases.", dead:true, deadReason:"No recent snippet confirms this link; page date suggests stale rumour"},
