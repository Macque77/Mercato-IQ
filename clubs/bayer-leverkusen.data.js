...
const CONFIRMED_OUT = [
  ...
  {name:"Kerim Alajbegovic", sub:"18 · Bosnia and Herzegovina · AM", club:"Juventus", pos:"AM", fee:"30m euros guaranteed, rising with add-ons", free:false, status:"done", statusTxt:"DONE, OFFICIAL", note:"Completed on 2 August, with Juventus confirming a five-year contract to 2031 and a guaranteed fee of 30m euros payable over four instalments. Headline figures of 35m include performance bonuses, so treat that number with care."}
];
...
const LINKMAP = {
  ...
  "Miguel Gutierrez": ["bundesligacomMiguelGutierrez"],
  "Kerim Alajbegovic": ["getGermanFootballNewsKerimAlajbegovic"]};
const WL_LINKMAP = {};
