...
const CONFIRMED_IN = [
  ...
  {name:"Miguel Gutierrez", sub:"25 · Spain · LB", club:"Napoli", pos:"LB", fee:"26m euros (up to around 30m with bonuses)", free:false, status:"done", statusTxt:"DONE, OFFICIAL", note:"Officially confirmed on 5 August, a five-year deal to 2031 and the No 3 shirt. He replaces Alejandro Grimaldo, who joined Atletico Madrid, and made 36 competitive appearances last season."}
];
...
const CONFIRMED_OUT = [
  ...
  {name:"Kerim Alajbegovic", sub:"22 · Bosnia and Herzegovina · Midfielder", club:"Juventus", pos:"MF", fee:"Undisclosed", free:false, status:"done", statusTxt:"DONE, OFFICIAL", note:"Confirmed transfer"}
];

const INCOMING = [
  {name:"Moussa Diaby", sub:"Talk of sensational Bundesliga return", club:"Al-Ittihad", pos:"RW", report:"Leverkusen are reportedly plotting a €30m reunion with Diaby, who scored 96 goals in 172 appearances for the club before his 2023 move to Aston Villa.", src:"Goal.com", tier:3, fee:"Undisclosed", truth:45, prob:20, light:"o", trend:"flat", note:"Speculative reunion story with no indication Al-Ittihad are willing sellers.", lastSeen:"2026-08-04T19:10:50Z", baseProb:20, dead:true, deadReason:"Rumour of €30m reunion – no credible follow-up confirming deal or material progress in recent snippets"},
  {name:"Zakaria El Ouahdi", sub:"Identified as alternative to Medina at right-back", club:"KRC Genk", pos:"RB", report:"Leverkusen have identified the Morocco international full-back as a fallback option to Facundo Medina, with Genk said to be demanding a fee that makes 'top clubs swallow hard'.", src:"Kicker", tier:2, fee:"Undisclosed", truth:55, prob:25, light:"o", trend:"flat", note:"Reported as secondary target behind Medina; Genk resisting a cut-price sale.", lastSeen:"2026-08-04T19:10:50Z", baseProb:25, dead:true, deadReason:"Rumour of identification – no credible follow-up confirming deal or material progress in recent snippets"},
  {name:"Miguel Gutierrez", sub:"Left-back · Spain", club:"Real Madrid", pos:"LB", report:"Transfer completed; described as 'Absolute wish solution'", src:"Absolut Fussball", tier:3, fee:"Undisclosed", truth:100, prob:100, light:"g", trend:"flat", note:"Deal confirmed as fixed", lastSeen:"2026-08-08T18:06:11Z", baseProb:100}
];

const OUTGOING = [
  {name:"Kerim Alajbegovic", sub:"22 · Bosnia and Herzegovina · Midfielder", club:"Juventus", pos:"MF", report:"Transfer to Juventus confirmed", src:"Sky.de", tier:2, fee:"Undisclosed", truth:100, prob:100, light:"g", trend:"flat", note:"Deal completed", lastSeen:"2026-08-08T18:06:11Z", baseProb:100}
];
...
const HUB = {
  ...
  bundesligacomMiguelGutierrez: {l:"Bundesliga.com", u:"https://www.bundesliga.com/en/bundesliga/news/miguel-gutierrez-joins-leverkusen-napoli-grimaldo-38428"},
  getGermanFootballNewsKerimAlajbegovic: {l:"Get German Football News", u:"https://www.getfootballnewsgermany.com/2026/kerim-alajbegovic-juve-done/"},
  absolutFussballMiguelGutierrez: {l:"Absolut Fussball", u:"https://news.google."},
  skydeKerimAlajbegovic: {l:"Sky.de", u:"https://news.google."}};
...
const LINKMAP = {
  ...
  "Miguel Gutierrez": ["bundesligacomMiguelGutierrez", "absolutFussballMiguelGutierrez"],
  "Kerim Alajbegovic": ["getGermanFootballNewsKerimAlajbegovic", "skydeKerimAlajbegovic"]};
const WL_LINKMAP = {};
