...
const INCOMING = [
  ...
  {name:"Maxence Lacroix", sub:"24 · France · D", club:"Crystal Palace", pos:"D", report:"Chelsea finalising £52m deal, set to undergo medical", src:"David Ornstein", tier:1, fee:"£52m", truth:90, prob:85, light:"g", trend:"down", note:"Deal in final stages", lastSeen:"2026-08-08T14:10:31Z", baseProb:85},
...
const OUTGOING = [
  {name:"Enzo Fernández", sub:"23 · Argentina · M", club:"Chelsea", pos:"M", report:"Man City eyeing Enzo Fernández as Bernardo Silva replacement", src:"Laurie Whitwell", tier:2, fee:"Unknown", truth:65, prob:50, light:"y", trend:"up", note:"Interest from Man City reported", lastSeen:"2026-08-08T14:10:31Z", baseProb:50}
];
const DEAD = [
