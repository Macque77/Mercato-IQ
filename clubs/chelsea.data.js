...
const INCOMING = [
  {name:"Victor Osimhen", sub:"Napoli · ST", club:"Napoli", pos:"ST", report:"Chelsea have been credited with interest", src:"Transfer Rumour", tier:3, fee:"Unknown", truth:40, prob:25, light:"o", trend:"up", note:"Interest reported, early stage", lastSeen:"2026-08-06T13:55:46Z", baseProb:25},
  {name:"Pep Chavarria", sub:"Rayo Vallecano · LB", club:"Rayo Vallecano", pos:"LB", report:"Chelsea set to clinch deal to sign Rayo Vallecano left-back", src:"Sky Sports", tier:2, fee:"Undisclosed", truth:85, prob:80, light:"g", trend:"down", note:"Deal reported imminent", lastSeen:"2026-08-06T13:55:46Z", baseProb:80}
];

const OUTGOING = [
  {name:"Pedro Neto", sub:"Chelsea · W", club:"Manchester City", pos:"W", report:"Manchester City have made a formal approach", src:"Transfer Rumour", tier:3, fee:"Unknown", truth:50, prob:40, light:"y", trend:"up", note:"City inquiry reported", lastSeen:"2026-08-06T13:55:46Z", baseProb:40}
];
const DEAD = [
