...
const INCOMING = [
  ...
  {name:"Pep Chavarria", sub:"28 · Spain · LB", club:"Rayo Vallecano", pos:"LB", report:"Chelsea are close to agreeing a deal worth about £16.3m for the Rayo Vallecano left-back, a target they have chased for much of the window. All parties are confident it will be struck. Chavarria, who played the full 90 minutes of last season's Conference League final defeat by Crystal Palace, is contracted to 2030 with a reported €50m release clause, but Chelsea are negotiating a separate figure rather than triggering it. He would provide competition for Jorrel Hato following Marc Cucurella's exit.", src:"PA / The Athletic", tier:2, fee:"£16.3m", truth:92, prob:85, light:"g", trend:"down", note:"Solidly sourced through PA and The Athletic, though nothing is signed and the gap between the quoted fee and the release clause leaves room for late haggling.", lastSeen:"2026-08-06T08:09:17Z", baseProb:85}
];
