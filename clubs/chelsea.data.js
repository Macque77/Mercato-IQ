...
const INCOMING = [
  ...
  {name:"Maxence Lacroix", sub:"24 · France · D", club:"Crystal Palace", pos:"D", report:"Chelsea finalising £52m deal, set to undergo medical", src:"David Ornstein", tier:1, fee:"£52m", truth:95, prob:90, light:"g", trend:"flat", note:"Medical scheduled", lastSeen:"2026-08-08T11:19:01Z", baseProb:90},
...
const OUTGOING = [
  {name:"Enzo Fernández", sub:"23 · Argentina · M", club:"Chelsea", pos:"M", report:"Man City eyeing Enzo Fernández as Bernardo Silva replacement", src:"Laurie Whitwell", tier:2, fee:"Unknown", truth:70, prob:40, light:"y", trend:"up", note:"Man City interest reported; Chelsea unlikely to sell", lastSeen:"2026-08-08T10:03:39Z", baseProb:40}
];
const DEAD = [
