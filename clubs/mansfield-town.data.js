...
const CONFIRMED_IN = [
  ...
  {name:"Tyler Roberts", sub:"", club:"", pos:"", fee:"", free:false, status:"done", statusTxt:"DONE, OFFICIAL", note:"Signed"},
  {name:"Liam Thompson", sub:"", club:"Derby County", pos:"", fee:"", free:false, status:"done", statusTxt:"DONE, OFFICIAL", note:"Departs from Derby County for Mansfield Town"}
];
const CONFIRMED_OUT = [
...
const INCOMING = [
  {name:"David McGoldrick", sub:"ST", club:"Barnsley", pos:"ST", report:"Signed", src:"Various", tier:0, fee:"Undisclosed", truth:35, prob:20, light:"o", trend:"down", note:"Barnsley reportedly confident he stays, so treat as a long shot.", lastSeen:"2026-08-07T23:07:30Z", baseProb:20},
...
const HUB = {
  ...
  bBCMichaelSmith1: {l:"BBC", u:"https://news.google.com/rss/articles/CBMiZ0FVX3lxTE9BUVA0dFkxS3E5WFp4eHZ2ZGFiTzIzX0FYUDZVc0w5cURaMnpDMzZjZzZNSkFqYVhrSG83SldOODR3UFJFMVUzbWFGYmpHcEhQbVlPWk5zSUNFZ2h5Y1dvX1FKcldWb28?oc=5"},
  bBCJonRussell1: {l:"BBC", u:"https://news.google.com/rss/articles/CBMiZ0FVX3lxTE9QTktyTFFxa3FNOTFSRGN5OC15dGVfOTdjZ1dEUUF1UzcwWWVyUUhTZzduaGdVaDJjcnJnMkRKSmJXalVFRllNamVhaV93ZnplNE4yeVE5dERSU0l5TEl1dTJHWEdyeVE?oc=5"},
  bBCTylerRoberts1: {l:"BBC", u:"https://news.google.com/rss/articles/CBMiZ0FVX3lxTFBFME5kajM5bVp6LU1mS3BSNHJ0ZmtnNzhQRlNFMDBNZnhhdTRybDBTQTF2TGFvSzMtdWRmR1VhTVJxYktobml1ck9GdFdVZXBSRzVEWnFLOVUySXM4Q1VBd2dDU0tjbGM?oc=5"},
  ...
  mansfieldandAshfieldChadWillEvans1: {l:"Mansfield and Ashfield Chad", u:"https://news.google.?oc=5"}};

const LINKMAP = {
  "David McGoldrick": ["gnews-davidmcgoldrick"],
  "Michael Smith": ["bBCMichaelSmith", "bBCMichaelSmith1"],
  "Jon Russell": ["bBCJonRussell", "bBCJonRussell1"],
  "Tyler Roberts": ["bBCTylerRoberts", "bBCTylerRoberts1"],
  "George Abbott": ["bBCTylerRoberts", "bBCTylerRoberts1"],
  "Liam Thompson": ["derbyshireLiveLiamThompson", "derbyCountyLiamThompson", "derbyshireLiveLiamThompson1"],
  "Will Evans": ["chadcoukWillEvans", "mansfieldandAshfieldChadWillEvans", "mansfieldandAshfieldChadWillEvans1"]};
const WL_LINKMAP = {};
