...
const INCOMING = [
  ...
  {name:"Tom O'Connor", sub:"unknown · unknown · unknown", club:"Wrexham", pos:"unknown", report:"Sealed permanent switch to Peterborough United from Wrexham", src:"BBC", tier:2, fee:"Undisclosed", truth:100, prob:100, light:"g", trend:"flat", note:"Confirmed permanent transfer", lastSeen:"2026-08-08T16:04:57Z", baseProb:100}
];
const OUTGOING = [
  {name:"Kyrell Lisbie", sub:"unknown · unknown · Winger", club:"Millwall", pos:"Winger", report:"Signed by Millwall on 'long-term' deal", src:"BBC", tier:2, fee:"Undisclosed", truth:100, prob:100, light:"g", trend:"flat", note:"Confirmed transfer to Championship side", lastSeen:"2026-08-08T16:04:57Z", baseProb:100}
];
const RISERS = [];
const FALLERS = [];
const NEW = [];
