...
const INCOMING = [
  ...
  {name:"Tom O'Connor", sub:"Unknown · Unknown · Unknown", club:"Wrexham", pos:"Unknown", report:"Sealed permanent switch to Peterborough United from Wrexham", src:"BBC", tier:2, fee:"Undisclosed", truth:100, prob:100, light:"g", trend:"flat", note:"Confirmed permanent transfer", lastSeen:"2026-08-08T18:06:10Z", baseProb:100}
];
const OUTGOING = [
  {name:"Kyrell Lisbie", sub:"Unknown · Unknown · W", club:"Millwall", pos:"Winger", report:"Signed by Millwall on 'long-term' deal", src:"BBC", tier:2, fee:"Undisclosed", truth:100, prob:100, light:"g", trend:"flat", note:"Long-term deal confirmed", lastSeen:"2026-08-08T18:06:10Z", baseProb:100}
];
const RISERS = [];
const FALLERS = [];
const NEW = [];
...
const HUB = {
  ...
  bBCSportTomOConnor: {l:"BBC Sport", u:"https://news.google.com/rss/articles/CBMiZ0FVX3lxTFBlMDJZMkhEZGgzbTRJUmUxMVo1TnMzejZNaDVDaU8wS210NnNXYkNJNW0yVEhNOGFOOThCZWtaVEVXQmF1UV9zdEZWT0hEMzhjd0s1ZkZMTWFWRzNjS2ZYMnVxRGFoOHc"},
  bBCKyrellLisbie1: {l:"BBC", u:"https://news.google.com/rss/articles/CBMiZ0FVX3lxTFhPJeDRlbkJXX0IwaFZlTnowZlBpOWp1U0R1ZG0wWXFzeVQ1eHIySmRQTHdTcHBPMHdIekZuajRpYWF0QWtnTkZDQVVQZEFBaFRXaW9LMWpCVzJwT2RrTHI3Yy05MXZGT0E"}};

const LINKMAP = {
  "Kyreece Lisbie": ["gnews-kyreecelisbie"],
  "Harry Ashfield": ["gnews-harryashfield"],
  "Tom O'Connor": ["bBCTomOConnor", "bBCSportTomOConnor"],
  "Harrison Jones": ["peterboroughTelegraphHarrisonJones"],
  "Kyrell Lisbie": ["bBCKyrellLisbie", "bBCKyrellLisbie1"]};
const WL_LINKMAP = {};
