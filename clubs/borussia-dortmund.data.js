...
const INCOMING = [
  ...
  {name:"Said El Mala", sub:"Protracted, rocky negotiations with Köln", club:"1. FC Köln", pos:"RW", report:"Talks have repeatedly stalled over the fee, with Köln reportedly ending negotiations after an 'insulting' offer and RB Leipzig and Roma both joining the race for the winger.", src:"Yahoo Sports (Sky Germany feed)", tier:2, fee:"Undisclosed", truth:60, prob:25, light:"o", trend:"flat", note:"Multiple reports of collapsed negotiations; deal now seen as genuinely in doubt with rivals circling.", lastSeen:"2026-08-04T19:10:50Z", baseProb:25},
