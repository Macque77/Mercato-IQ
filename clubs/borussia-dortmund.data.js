...
const INCOMING = [
  ...
  {name:"Said El Mala", sub:"Protracted, rocky negotiations with Köln", club:"1. FC Köln", pos:"RW", report:"Talks have repeatedly stalled over the fee, with Köln reportedly ending negotiations after an 'insulting' offer and RB Leipzig and Roma both joining the race for the winger.", src:"Yahoo Sports (Sky Germany feed)", tier:2, fee:"Undisclosed", truth:60, prob:25, light:"o", trend:"flat", note:"Multiple reports of collapsed negotiations; deal now seen as genuinely in doubt with rivals circling."},
  {name:"Gilberto Mora", sub:"Early-stage interest in Mexican wonderkid", club:"Club Tijuana (Xolos)", pos:"CAM", report:"Dortmund and Benfica have officially reached out to explore signing the highly-rated 18-year-old, in a club long known for developing young talents like Bellingham and Haaland.", src:"Soy Fútbol", tier:3, fee:"Undisclosed", truth:50, prob:15, light:"o", trend:"flat", note:"Very early-stage interest; several European clubs reportedly circling the Mexican international."},
  {name:"Fisnik Asllani", sub:"On shortlist, but RB Leipzig now favourites", club:"TSG Hoffenheim", pos:"ST", report:"Asllani remains on Dortmund's shortlist of attacking targets and is 'open' to the move, though recent reporting points to RB Leipzig as the frontrunner for the €30m-rated striker.", src:"Yahoo Sports UK", tier:2, fee:"Undisclosed", truth:55, prob:15, light:"o", trend:"flat", note:"Leipzig reported to have overtaken Dortmund in the race for this target."}
];

const OUTGOING = [
  {name:"Yan Couto", sub:"Loan to Como nearing completion", club:"Como 1907", pos:"RB", report:"Couto is now set for a loan move to Serie A side Como, with a purchase option reportedly included after several weeks of difficult negotiations.", src:"Yahoo Sports", tier:2, fee:"Undisclosed", truth:75, prob:80, light:"g", trend:"flat", note:"Described as close to completion, with Como manager Fabregas confirming continued market activity."}
];
...
const HUB = {
  ...
  yahooSportsSaidElMala: {l:"Yahoo Sports", u:"https://sports.yahoo.com/articles/k-ln-reportedly-end-negotiations-103900759.html"},
  soyFtbolGilbertoMora: {l:"Soy Fútbol", u:"https://www.soyfutbol.com/en/trends/borussia-dortmund-and-benfica-lead-the-race-for-gilberto-mora-the-bidding-war-for-xolos-rising-star-heats-up-20260802-0028.html"},
  yahooSportsUKFisnikAsllani: {l:"Yahoo Sports UK", u:"https://uk.sports.yahoo.com/news/bvb-news-rumours-talks-resumed-020314737.html"},
...
const LINKMAP = {
  ...
  "Julian Brandt": ["bein","ajax", "yahooSportsJulianBrandt"],
  "Cole Campbell": ["90min"],
  "Salih Özcan": ["90min"],
  "Niklas Süle": ["90min"],
