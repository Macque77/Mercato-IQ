...
const INCOMING = [
  ...
  {name:"Yerson Mosquera", sub:"Colombian centre-back linked as depth option", club:"Wolverhampton Wanderers", pos:"CB", report:"Rennes are searching for a central defender to compete for a starting spot ahead of their Europa League campaign, with Wolves' Mosquera among options considered, though the player is still building fitness after a serious ACL injury.", src:"Ouest-France", tier:3, fee:"Undisclosed", truth:45, prob:25, light:"o", trend:"flat", note:"Described as one of several defensive targets rather than a firm negotiation; recent ACL history may affect Rennes' final decision."}
];
