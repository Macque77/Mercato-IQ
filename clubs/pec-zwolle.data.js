...
const INCOMING = [
  {name:"Leandro Rousseau", sub:"23 · ST · Belgium", club:"Patro Eisden", pos:"ST", report:"28 Jul 2026", src:"VoetbalPrimeur.nl", tier:2, fee:"~€1m valuation", truth:60, prob:25, light:"o", trend:"flat", note:"PEC are one of four suitors (with Gent, Saint-Étienne and Hertha BSC) chasing the in-form Belgian striker, who'd compete with Koen Kostons up top.", lastSeen:"2026-08-04T19:10:50Z", baseProb:25},
  {name:"Kévin Monzialo", sub:"ST", club:"FC Den Bosch", pos:"ST", report:"May 2026", src:"Mounir Boualin / Brabants Dagblad", tier:2, fee:"Foreign offers reportedly over €1m", truth:55, prob:25, light:"o", trend:"flat", note:"On PEC's forward shortlist after 18 goals and 14 assists in the Keuken Kampioen Divisie, but foreign clubs are also said to have tabled bids north of €1m.", lastSeen:"2026-08-04T19:10:50Z", baseProb:25}
];
const OUTGOING = [
  {name:"Jasper Schendelaar", sub:"25 · GK · Netherlands", club:"PEC Zwolle", pos:"GK", report:"8 Jul 2026", src:"Voetbal International", tier:1, fee:"~€1.5m (Transfermarkt est.)", truth:70, prob:45, light:"y", trend:"flat", note:"Sparta Rotterdam's top keeper target following Joël Drommel's PSV return; PEC are willing to sell but no formal bid has landed yet.", lastSeen:"2026-08-04T19:10:50Z", baseProb:45},
  {name:"Ryan Thomas", sub:"MF", club:"Open to bids (no confirmed suitor)", pos:"MF", report:"Club has indicated 'the door remains open' for a departure if an offer arrives, though no suitor is named yet.", src:"PEC Zwolle Nieuws", tier:3, fee:"N/A", truth:45, prob:15, light:"o", trend:"flat", note:"27 Jul 2026.", lastSeen:"2026-08-04T19:10:50Z", baseProb:15}
];
const RISERS = [];
const FALLERS = [];
const NEW = [];
