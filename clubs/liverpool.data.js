...
const OUTGOING = [
  ...
  {name:"Ibrahima Konaté", sub:"CB · France", club:"Real Madrid", pos:"CB", report:"~2 days ago", src:"90min", tier:3, fee:"£50m+ or free risk", truth:55, prob:38, light:'y', trend:'up',
   note:"Linked as one of Real Madrid's first 2026/27 reinforcements. PRICING: contract status drives this, if he is entering his final year, Liverpool must weigh selling now versus a free later. A pivotal defensive decision."},
...
`,
  ...
  methodLegend: `
      ...
      <div class="col">
        ...
        <div class="row" style="margin-top:10px"><span class="k" style="color:var(--gold)">NB</span><span>Recycled aggregator repetition does <b>not</b> refresh recency. Slot-era and recycled 2025 links fall on this basis.</span></div>
