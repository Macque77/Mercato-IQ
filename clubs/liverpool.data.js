...
const INCOMING = [
  {name:"Bradley Barcola", sub:"22 · France · W", club:"Paris Saint-Germain", pos:"W", report:"Ornstein reveals Barcola stance on joining Liverpool in £116m deal", src:"David Ornstein", tier:1, fee:"£116m", truth:65, prob:40, light:"y", trend:"up", note:"PSG winger targeted; fee reported but Barcola's willingness unclear", lastSeen:"2026-08-08T14:10:32Z", baseProb:40},
  {name:"Raul Asencio", sub:"21 · Spain · CB", club:"Real Madrid", pos:"CB", report:"Intermediaries sounded Liverpool out on Asencio", src:"Multiple sources", tier:3, fee:"Undisclosed", truth:35, prob:25, light:"o", trend:"down", note:"Early-stage interest via intermediaries; Real Madrid defender", lastSeen:"2026-08-08T14:10:32Z", baseProb:25},
  {name:"Yan Diomande", sub:"20 · Ivory Coast · CB", club:"RB Leipzig", pos:"CB", report:"Ornstein drops huge Diomande to Liverpool update after Leipzig star declares 'love' for PSG", src:"David Ornstein", tier:1, fee:"Undisclosed", truth:35, prob:20, light:"o", trend:"flat", note:"Diomande's PSG preference reportedly complicates Liverpool move", lastSeen:"2026-08-08T10:03:40Z", baseProb:20, dead:true, deadReason:"Ornstein confirms 'hammer blow' / 'crushing blow' – deal collapsed; Leipzig star declared love for PSG"},
...
const OUTGOING = [
  {name:"Cody Gakpo", sub:"25 · Netherlands · W", club:"Liverpool", pos:"W", report:"Tottenham made Gakpo a target; BBC Sport questions exit", src:"BBC Sport", tier:2, fee:"Undisclosed", truth:40, prob:30, light:"y", trend:"flat", note:"Spurs interest reported; Liverpool position unclear", lastSeen:"2026-08-08T14:10:32Z", baseProb:30}
];
const DEAD = [
...
const LINKMAP = {
  "Yan Diomande": ["teamtalk", "football365DavidOrnsteinYanDiomande", "football365DavidOrnsteinYanDiomande1"],
  "Rayan": ["lcom"],
