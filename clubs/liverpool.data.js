...
const INCOMING = [
  ...
  {name:"Yan Diomande", sub:"20 · Ivory Coast · CB", club:"RB Leipzig", pos:"CB", report:"Ornstein reports competition for Diomande; player declares 'love' for PSG; crushing blow confirmed", src:"David Ornstein", tier:1, fee:"Unknown", truth:55, prob:30, light:"y", trend:"up", note:"Diomande's preference for PSG significantly weakens Liverpool's chances; Ornstein confirms setback", lastSeen:"2026-08-08T18:06:10Z", baseProb:30},
...
const OUTGOING = [
  {name:"Cody Gakpo", sub:"25 · Netherlands · W", club:"Liverpool", pos:"W", report:"Tottenham made Gakpo a target; BBC Sport questions transfer possibility", src:"BBC Sport", tier:2, fee:"Unknown", truth:50, prob:35, light:"y", trend:"flat", note:"Tottenham interest reported; no advanced talks confirmed", lastSeen:"2026-08-08T18:06:10Z", baseProb:35}
];
const DEAD = [
...
const HUB = {
  ...
  bBCSportCodyGakpo1: {l:"BBC Sport", u:"https://www.bbc.com/sport"}};
const LINKMAP = {
  ...
  "Cody Gakpo": ["vi","echo", "tEAMtalkcitingFabrizioRomanoCodyGakpo", "bBCSportFootballCodyGakpo", "bBCSportFootballCodyGakpo1", "bBCSportCodyGakpo", "readliverpoolfccomviaDavidOrnsteinYanDiomande", "bBCSportCodyGakpo1"],
