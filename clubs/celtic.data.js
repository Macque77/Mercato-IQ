...
const INCOMING = [
  ...
  {name:"Fares Ghedjemis", sub:"23 · W · Algeria", club:"Frosinone", pos:"W", report:"3 Aug 2026", src:"Fraser Fletcher / TEAMtalk", tier:2, fee:"£6-8m", truth:55, prob:35, light:'y', trend:'flat', note:"Celtic's opening £6m bid was rejected, with Frosinone wanting £8m+; the winger is reportedly enthusiastic about the move, but Rangers have since submitted a rival hijack bid."},
  {name:"Greg Taylor", sub:"28 · LB · Scotland", club:"PAOK", pos:"LB", report:"31 Jul 2026", src:"67 Hail Hail (via Daily Record, Greece)", tier:2, fee:"Undisclosed", truth:50, prob:33, light:'y', trend:'up', note:"Taylor has fallen out of favour under PAOK's new coach after just a year away, with a Celtic return said to be gathering momentum."}
];
const OUTGOING = [
  ...
  {name:"Arne Engels", sub:"22 · MF · Belgium", club:"West Ham United", pos:"MF", report:"31 Jul 2026", src:"Sky Sports", tier:1, fee:"Undisclosed", truth:75, prob:58, light:'g', trend:'up', note:"West Ham are in active negotiations for the Belgian midfielder, fending off earlier Nottingham Forest interest."}
];
const RISERS = [];
const FALLERS = [];
const NEW = [];
