...
const INCOMING = [
  {name:"Young data-model targets", sub:"Value recruitment", club:"Market", pos:"ANY", report:"window framing", src:"Model-based", tier:3, fee:"£50-90m total", truth:55, prob:45, light:'y', trend:'up',
   note:"Brighton's intake is built through their analytics network rather than headline pursuits. Specific names firm up as the window opens; this row frames the expected pattern, not an invented target.", lastSeen:"2026-08-04T19:10:50Z", baseProb:45},
  {name:"Squad depth for Europe", sub:"Rotation additions", club:"Market", pos:"ANY", report:"window framing", src:"Model-based", tier:3, fee:"Value adds", truth:55, prob:40, light:'y', trend:'flat',
   note:"A Conference League campaign stretches the squad, so depth additions across positions are expected alongside the headline intake. Framing thread carried from the v1 positions panel; no specific name asserted without sourcing.", lastSeen:"2026-08-04T19:10:50Z", baseProb:40},
  {name:"Forward options", sub:"Goals and ceiling", club:"Market", pos:"FW", report:"window framing", src:"Model-based", tier:3, fee:"TBC", truth:55, prob:30, light:'y', trend:'flat',
   note:"The v1 positions panel flagged forward options (goals and ceiling) as a likely strand of the intake. Framing thread only; names firm up as the window opens.", lastSeen:"2026-08-04T19:10:50Z", baseProb:30},
  {name:"Said El Mala", sub:"Winger, German (Lebanese heritage), 19", club:"1. FC Köln", pos:"RW", report:"Brighton are pushing for final talks with Köln and have offered contracts to both Said El Mala and his brother Malek, with a fee expected around €35m.", src:"Sport Bild", tier:2, fee:"€35m (est.)", truth:70, prob:45, light:"y", trend:"flat", note:"Bayern Munich reported to have pulled out of the race as Köln hold firm on valuation; deal has dragged on for months", lastSeen:"2026-08-04T19:10:50Z", baseProb:45},
  {name:"Roony Bardghji", sub:"Winger, Swedish, 20", club:"Barcelona", pos:"RW", report:"Brighton are the frontrunners to sign the out-of-favour Barcelona winger permanently, though Barça want a buy-back clause and Brighton have conditioned a bid on selling Yankuba Minteh first.", src:"Sport (Spain)", tier:2, fee:"Undisclosed", truth:65, prob:40, light:"y", trend:"flat", note:"Competition from Aston Villa, Leeds, Sunderland, Fulham and Everton reported", lastSeen:"2026-08-04T19:10:50Z", baseProb:40},
  {name:"Arijon Ibrahimovic", sub:"Midfielder/winger, German-Kosovan, 19", club:"Bayern Munich", pos:"CAM", report:"Brighton are among several Premier League clubs (also linked: Aston Villa, Crystal Palace, Fulham) monitoring the Bayern Munich attacking talent as he weighs a move for regular first-team football.", src:"Bavarian Football Works / German media", tier:3, fee:"Undisclosed", truth:55, prob:25, light:"o", trend:"flat", note:"Bayern have since begun integrating him into the first-team squad for 2026/27, cooling exit speculation somewhat", lastSeen:"2026-08-04T19:10:50Z", baseProb:25},
  {name:"Noah Atubolu", sub:"Goalkeeper, German, 23", club:"SC Freiburg", pos:"GK", report:"Brighton are shortlisted as suitors for Freiburg's Atubolu as a potential long-term successor to Bart Verbruggen, should the Dutchman depart, though he is not reported as the club's top-choice option.", src:"Florian Plettenberg", tier:1, fee:"Undisclosed", truth:80, prob:30, light:"y", trend:"flat", note:"Contingent on Verbruggen leaving; Atubolu could also leave Freiburg on a free in 2027", lastSeen:"2026-08-04T19:10:50Z", baseProb:30}
];
...
const OUTGOING = [
  {name:"Prized asset (premium sale)", sub:"The model in action", club:"Elite suitors", pos:"ANY", report:"window framing", src:"Pattern-based", tier:3, fee:"£40m+", truth:55, prob:55, light:'g', trend:'up',
   note:"A near-inevitable feature of any Brighton summer: a developed star sold at a premium to a bigger club. PRICING: long contracts and multi-club interest stack the fee; proceeds fund the next intake.", lastSeen:"2026-08-04T19:10:50Z", baseProb:55},
