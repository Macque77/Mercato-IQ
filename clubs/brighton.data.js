...
const INCOMING = [
  ...
  {name:"Ayase Ueda", sub:"24 · Japan · F", club:"Feyenoord", pos:"F", report:"Brighton make concrete move for Feyenoord striker", src:"Football Place", tier:3, fee:"", truth:65, prob:50, light:"y", trend:"up", note:"Concrete interest reported; no recent updates on progress", lastSeen:"2026-08-08T07:40:33Z", baseProb:50}
];

const OUTGOING = [
  {name:"Jan Paul van Hecke", sub:"23 · Belgium · D", club:"Tottenham Hotspur", pos:"D", report:"Tottenham agree £52million Jan Paul van Hecke transfer with Brighton", src:"The Athletic", tier:1, fee:"£52m", truth:95, prob:90, light:"g", trend:"down", note:"Deal agreed per David Ornstein; high confidence transfer", lastSeen:"2026-08-08T07:40:33Z", baseProb:90},
  {name:"Solly March", sub:"30 · England · M", club:"Crystal Palace", pos:"M", report:"Crystal Palace consider shock free transfer for Brighton icon Solly March", src:"Goal.com", tier:3, fee:"Free", truth:60, prob:45, light:"y", trend:"up", note:"Palace in advanced talks", lastSeen:"2026-08-08T07:40:33Z", baseProb:45}
];
const DEAD = [
