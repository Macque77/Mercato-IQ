...
const OUTGOING = [
  {name:"Bruno Guimarães", sub:"28 · Brazil · CM", club:"Newcastle United", pos:"CM", report:"Arsenal have agreed fee with Newcastle for Bruno Guimarães", src:"On-page rumour", tier:2, fee:"Undisclosed", truth:85, prob:75, light:"g", trend:"up", note:"Fee agreed between clubs; deal progressing", lastSeen:"2026-08-08T18:06:10Z", baseProb:75},
  {name:"Anthony Gordon", sub:"23 · England · W", club:"Newcastle United", pos:"W", report:"David Ornstein reveals Newcastle's stance on Anthony Gordon's Future", src:"David Ornstein", tier:1, fee:"Undisclosed", truth:70, prob:60, light:"g", trend:"flat", note:"Ornstein confirms Gordon wants to leave; Newcastle's position on sale unclear", lastSeen:"2026-08-08T18:06:10Z", baseProb:60}
];
const DEAD = [
...
const HUB = {
  ...
  cominghomenewcastlesbnationcomviaDavidOrnsteinAnthonyGordon: {l:"cominghomenewcastle.sbnation.com (via David Ornstein)", u:"https://news.google."}};
const LINKMAP = {
  ...
  "Anthony Gordon": ["skyNUFC", "skySportsAnthonyGordon", "sBNationviaDavidOrnsteinAnthonyGordon", "cominghomenewcastlesbnationcomviaDavidOrnsteinAnthonyGordon"],
