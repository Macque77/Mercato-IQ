...
const CONFIRMED_IN = [
  ...
  {name:"Matthias Jaissle", sub:"43 · Austria · Manager", club:"Newcastle United", pos:"Head Coach", fee:"Undisclosed", free:false, status:"done", statusTxt:"DONE, OFFICIAL", note:"Appointed as Eddie Howe's successor"}
];
const CONFIRMED_OUT = [
...
const OUTGOING = [
  {name:"Bruno Guimarães", sub:"29 · Brazil · CM", club:"Arsenal", pos:"Midfielder", report:"Arsenal agree £75m fee with Newcastle for captain", src:"BBC Sport / Telegraph", tier:2, fee:"£75m", truth:95, prob:95, light:"g", trend:"flat", note:"Deal agreed between clubs", lastSeen:"2026-08-06T14:04:24Z", baseProb:95},
...
const DEAD = [
  ...
  {name:"Abde Ezzalzouli", sub:"", club:"", pos:"", report:"Incoming rumour", src:"On-page", tier:3, fee:"", truth:30, prob:20, light:"o", trend:"down", note:"Stable through late July; no recent confirmation", lastSeen:"2026-08-06T13:55:46Z", baseProb:20, dead:true, deadReason:"No recent credible reporting; no snippet support", dir:"in", deadAt:"2026-08-06T14:04:24Z"},
  {name:"Joaquín Oso", sub:"", club:"", pos:"", report:"Incoming rumour", src:"On-page", tier:3, fee:"", truth:25, prob:15, light:"o", trend:"up", note:"14 Jul 2026 update; no fresher info; likely stale", lastSeen:"2026-08-06T13:55:46Z", baseProb:15, dead:true, deadReason:"No recent credible reporting; no snippet support", dir:"in", deadAt:"2026-08-06T14:04:24Z"},
  {name:"Angelo Stiller", sub:"", club:"", pos:"", report:"Newcastle shortlist", src:"On-page", tier:3, fee:"", truth:20, prob:15, light:"o", trend:"down", note:"Added to shortlist only; early stage", lastSeen:"2026-08-06T13:55:46Z", baseProb:15, dead:true, deadReason:"No recent credible reporting; no snippet support", dir:"in", deadAt:"2026-08-06T14:04:24Z"},
  {name:"Jacob Murphy", sub:"", club:"", pos:"", report:"Outgoing rumour", src:"On-page", tier:3, fee:"", truth:30, prob:20, light:"o", trend:"down", note:"28 Jul 2026 update; no recent confirmation", lastSeen:"2026-08-06T13:55:46Z", baseProb:20, dead:true, deadReason:"No recent credible reporting; no snippet support", dir:"out", deadAt:"2026-08-06T14:04:24Z"},
  {name:"Lewis Hall", sub:"", club:"Manchester United", pos:"", report:"Manchester United considering move", src:"On-page", tier:3, fee:"", truth:25, prob:15, light:"o", trend:"down", note:"Only 'said to be considering'; no concrete development", lastSeen:"2026-08-06T13:55:46Z", baseProb:15, dead:true, deadReason:"No recent credible reporting; no snippet support", dir:"out", deadAt:"2026-08-06T14:04:24Z"},
  {name:"Nick Pope", sub:"", club:"", pos:"GK", report:"Outgoing rumour", src:"On-page", tier:3, fee:"", truth:20, prob:15, light:"o", trend:"down", note:"~Jul 2026; no fresher update; likely stale", lastSeen:"2026-08-06T13:55:46Z", baseProb:15, dead:true, deadReason:"No recent credible reporting; no snippet support", dir:"out", deadAt:"2026-08-06T14:04:24Z"},
  {name:"Joe Willock", sub:"", club:"", pos:"", report:"Outgoing rumour", src:"On-page", tier:3, fee:"", truth:30, prob:20, light:"o", trend:"down", note:"28-29 Jul 2026 update; no recent confirmation", lastSeen:"2026-08-06T13:55:46Z", baseProb:20, dead:true, deadReason:"No recent credible reporting; no snippet support", dir:"out", deadAt:"2026-08-06T14:04:24Z"},
  {name:"Nick Woltemade", sub:"", club:"", pos:"", report:"Outgoing rumour", src:"On-page", tier:3, fee:"", truth:25, prob:15, light:"o", trend:"flat", note:"~2 weeks old; minimal credibility", lastSeen:"2026-08-06T13:55:46Z", baseProb:15, dead:true, deadReason:"No recent credible reporting; no snippet support", dir:"out", deadAt:"2026-08-06T14:04:24Z"},
  {name:"Yoane Wissa", sub:"", club:"", pos:"", report:"Outgoing rumour", src:"On-page", tier:3, fee:"", truth:20, prob:10, light:"r", trend:"flat", note:"~2 weeks old; minimal credibility", lastSeen:"2026-08-06T13:55:46Z", baseProb:10, dead:true, deadReason:"No recent credible reporting; no snippet support", dir:"out", deadAt:"2026-08-06T14:04:24Z"},
  {name:"Dan Burn", sub:"", club:"", pos:"D", report:"Outgoing rumour", src:"On-page", tier:3, fee:"", truth:15, prob:10, light:"r", trend:"flat", note:"~4 weeks old; stale", lastSeen:"2026-08-06T13:55:46Z", baseProb:10, dead:true, deadReason:"No recent credible reporting; no snippet support", dir:"out", deadAt:"2026-08-06T14:04:24Z"},
  {name:"Fabian Schär", sub:"", club:"", pos:"D", report:"Outgoing rumour", src:"On-page", tier:3, fee:"", truth:15, prob:10, light:"r", trend:"flat", note:"~4 weeks old; stale", lastSeen:"2026-08-06T13:55:46Z", baseProb:10, dead:true, deadReason:"No recent credible reporting; no snippet support", dir:"out", deadAt:"2026-08-06T14:04:24Z"},
  {name:"Dan Burn & Fabian Schär", club:"Newcastle United", pos:"CB", dir:"out", age:"~4 wks", tier:3, note:"Both 34 with contracts expiring 2027; not an active sale story, but their situation is the direct driver of the Scalvini centre-back pursuit above. Monitoring only.", dead:true, deadReason:"no longer a current link", deadAt:"2026-08-06T13:55:46Z"},
  {name:"Kieran McKenna / Antonio Conte", club:"Alternate coaching candidates", pos:"Head coach", dir:"in", age:"~same day", tier:3, note:"Named alongside Jaissle as the search continues; no reported contact confirmed for either as of 30 Jul, well behind Jaissle in the reported pecking order.", dead:true, deadReason:"no longer a current link", deadAt:"2026-08-06T13:55:46Z"}
];
...
const HUB = {
  ...
  bBCSportFootballMatthiasJaissle: {l:"BBC Sport Football", u:"https://www.bbc.co.uk/sport/football/articles/cn4n0ypyx31o"},
...
const LINKMAP = {
  ...
  "Matthias Jaissle": ["jaissleTribuna","jaissleYahoo","jaissleGoal", "bBCSportFootballMatthiasJaissle", "skySportsFootballMatthiasJaissle"],
  "Giorgio Scalvini": ["tuttoAtalanta","scalviniHT","shieldsGaz"],
  "Abde Ezzalzouli": ["teamtalk","ezzalzouliFP"],
  "Joaquín Oso": ["osoSW"],
  "Bruno Guimarães": ["brunoSun","brunoFT","talksport","skyNUFC", "skySportsBrunoGuimares", "theGuardianFootballBrunoGuimares", "bBCSportFootballBrunoGuimares"],
