...
const OUTGOING = [
  {name:"Bruno Guimaraes", sub:"29 · Brazil · CM", club:"Newcastle United", pos:"CM", report:"Arsenal have agreed a fee with Newcastle for the midfielder's transfer", src:"BBC Sport / Telegraph", tier:2, fee:"£75m", truth:95, prob:95, light:"g", trend:"up", note:"Deal agreed between clubs; move to Arsenal", lastSeen:"2026-08-06T14:13:57Z", baseProb:95}
];
const DEAD = [
...
const LINKMAP = {
  ...
  "Bruno Guimaraes": ["skySportsTransferCentreBrunoGuimaraes", "bBCSportFootballBrunoGuimares1"]};
const WL_LINKMAP = {
