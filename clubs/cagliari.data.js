...
const INCOMING = [
  {name:"Daniel Maldini", sub:"23 · Italy · W", club:"AC Milan", pos:"W", report:"Loan with option to buy agreed", src:"tuttomercatoweb.com", tier:3, fee:"Loan", truth:90, prob:95, light:"g", trend:"up", note:"Operazione in prestito oneroso con diritto di riscatto", lastSeen:"2026-08-06T14:21:37Z", baseProb:95}
];

const OUTGOING = [
  {name:"Yerry Mina", sub:"30 · Colombia · D", club:"Cagliari", pos:"D", report:"Exit underway", src:"transferfeed", tier:3, fee:"Undisclosed", truth:70, prob:60, light:"g", trend:"up", note:"Departure reported ~3 weeks ago", lastSeen:"2026-08-06T14:21:37Z", baseProb:60},
  {name:"Sebastiano Esposito", sub:"23 · Italy · F", club:"Cagliari", pos:"F", report:"Relations broken; exit expected", src:"transferfeed", tier:3, fee:"Asking price approx. €18m", truth:75, prob:65, light:"g", trend:"up", note:"Relations between Esposito and Cagliari have broken down", lastSeen:"2026-08-06T14:21:37Z", baseProb:65}
];
const DEAD = [
  {name:"Unnamed Juventus prospect / loan replacement", sub:"Attacker, replacement plan if Esposito leaves", club:"Juventus", pos:"ST", report:"Cagliari are lining up a loan striker from Juventus as cover in case Sebastiano Esposito is sold before deadline day.", src:"Sportmediaset", tier:2, fee:"Loan (undisclosed)", truth:55, prob:40, light:"y", trend:"flat", note:"Player not yet named publicly; framed as a contingency plan tied to the Esposito situation.", lastSeen:"2026-08-04T19:10:50Z", baseProb:40, dead:true, deadReason:"no longer a current link", dir:"in", deadAt:"2026-08-06T14:21:38Z"}
];
...
const HUB = {
  ...
  tuttomercatowebcomDanielMaldini: {l:"tuttomercatoweb.com", u:"https://www.tuttomercatoweb.com/"}};
...
const LINKMAP = {
  ...
  "Daniel Maldini": ["gonfialaRetecitingFabrizioRomanoDanielMaldini", "tuttomercatowebcomDanielMaldini"],
