...
const OUTGOING = [
  {name:"El Bilal Touré", sub:"24 · ST · Mali", club:"Parma", pos:"ST", report:"2 Aug 2026", src:"Gianluca Di Marzio", tier:2, fee:"Loan with conditional mandatory purchase", truth:55, prob:50, light:"y", trend:"flat", note:"Di Marzio describes the loan as in its closing stages."},
  {name:"Matteo Bellanova", sub:"Right-back, ITA, 26", club:"Everton / Inter / Napoli (interest)", pos:"RB", report:"Everton lead a group of suitors that also includes Inter and Napoli, with Atalanta valuing the Italy international at €15-20m.", src:"TuttoMercatoWeb", tier:2, fee:"Undisclosed", truth:50, prob:30, light:"y", trend:"flat", note:"Multiple credible suitors named, but no formal bid confirmed yet."},
