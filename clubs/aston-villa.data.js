...
const INCOMING = [
  ...
  {name:"Matteo Ruggeri", sub:"24 · Italy · LB", club:"Atlético Madrid", pos:"LB", report:"Villa have reached an agreement with Atlético Madrid for Ruggeri, lined up as their fifth summer arrival and as the long-term answer at left-back after Lucas Digne's departure. Fabrizio Romano reports Atlético want to bank sales, Molina and possibly Ruggeri, before pushing on with their own business.", src:"Fabrizio Romano", tier:1, fee:"Undisclosed", truth:80, prob:72, light:"g", trend:"down", note:"Romano's update reached us relayed by TEAMtalk rather than through a primary link, and the deal is tied to Atlético's outgoings, so fee and timing remain fluid.", lastSeen:"2026-08-06T10:49:40Z", baseProb:72},
  {name:"Zion Suzuki", sub:"23 · Japan · GK", club:"Parma", pos:"GK", report:"The Parma goalkeeper remains on Villa's list, but Romano says Juventus have made him a priority and PSG would sign him then look at a loan if Lucas Chevalier can be sold. Juventus' offer has so far fallen short of Parma's valuation. Villa's move depends on Emiliano Martínez's future.", src:"Fabrizio Romano", tier:1, fee:"Undisclosed", truth:65, prob:25, light:"o", trend:"flat", note:"Weak for Villa specifically: the reporting centres on Juventus and PSG, and Villa only act if Martínez goes. Do not present this as an advanced Villa deal.", lastSeen:"2026-08-06T10:49:40Z", baseProb:25}
];
...
const LINKMAP = {
  ...
  "Matteo Ruggeri": ["marcaRubenUriaMatteoRuggeri", "tEAMtalkrelayingFabrizioRomanoMatteoRuggeri"],
  "Zion Suzuki": ["tEAMtalkrelayingFabrizioRomanoZionSuzuki"]};
const WL_LINKMAP = {
