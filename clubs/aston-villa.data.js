...
const INCOMING = [
  ...
  {name:"Matteo Ruggeri", sub:"24 · Italy · LB", club:"Atletico Madrid", pos:"Left-back", report:"Villa have reached an agreement in principle with Atletico Madrid for the Italy left-back, structured around an initial €18m plus a further €6m in add-ons. Unai Emery made the left side of his defence a priority with Lucas Digne closing on a move to Paris Saint-Germain, and Ruggeri had earlier been linked with Liverpool and Tottenham.", src:"Marca", tier:2, fee:"€24m (£21m) including add-ons", truth:80, prob:78, light:"g", trend:"flat", note:"The Athletic only has Villa 'considering' Ruggeri among several left-back options, while the agreement claim comes from Marca and Spanish reporter Ruben Uria. Fee reporting also varies between €24m and €25m, so the structure is not settled.", lastSeen:"2026-08-05T17:03:23Z", baseProb:78}
];
...
const LINKMAP = {
  ...
  "Matteo Ruggeri": ["marcaRubenUriaMatteoRuggeri"]};
const WL_LINKMAP = {
