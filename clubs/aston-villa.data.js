...
const INCOMING = [
  ...
  {name:"Lamine Camara", sub:"24 · Senegal · M", club:"AS Monaco", pos:"M", report:"Aston Villa agree €21m deal for 24-year-old midfielder", src:"Unknown", tier:3, fee:"€21m", truth:70, prob:65, light:"g", trend:"down", note:"Fee agreed reported", lastSeen:"2026-08-08T04:21:31Z", baseProb:65, dead:true, deadReason:"No fresh confirmation in recent snippets; deal status unclear"},
...
const OUTGOING = [
  {name:"Ezri Konsa", sub:"26 · England · D", club:"Liverpool", pos:"D", report:"Liverpool set to rival Arsenal for Aston Villa and England defender", src:"Sky Sports", tier:2, fee:"Undisclosed", truth:70, prob:65, light:"g", trend:"up", note:"Interest from multiple top clubs; Aston Villa increasingly concerned", lastSeen:"2026-08-08T10:03:39Z", baseProb:65},
  {name:"Youri Tielemans", sub:"26 · Belgium · M", club:"Manchester United", pos:"M", report:"Manchester United set to finalise Youri Tielemans move from Aston Villa due to £35m release clause", src:"The Athletic", tier:1, fee:"£35m", truth:85, prob:80, light:"g", trend:"down", note:"Release clause triggered; move being finalised", lastSeen:"2026-08-08T10:03:39Z", baseProb:80}
];
const DEAD = [
