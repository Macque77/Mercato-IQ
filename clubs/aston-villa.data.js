...
const INCOMING = [
  ...
  {name:"Alejandro Garnacho", sub:"20 · Spain · W", club:"Chelsea", pos:"W", report:"Aston Villa agree deal with Chelsea for winger", src:"David Ornstein", tier:1, fee:"Undisclosed", truth:85, prob:75, light:"g", trend:"flat", note:"Deal agreed between clubs", lastSeen:"2026-08-07T23:07:29Z", baseProb:75}
];

const OUTGOING = [
  {name:"Ezri Konsa", sub:"26 · England · D", club:"Aston Villa", pos:"D", report:"Liverpool set to rival Arsenal for Aston Villa defender", src:"Sky Sports", tier:2, fee:"Undisclosed", truth:60, prob:50, light:"y", trend:"down", note:"Multiple clubs interested", lastSeen:"2026-08-07T23:07:29Z", baseProb:50},
  {name:"Youri Tielemans", sub:"27 · Belgium · M", club:"Aston Villa", pos:"M", report:"Manchester United set to finalise move due to £35m release clause", src:"David Ornstein", tier:1, fee:"£35m", truth:90, prob:85, light:"g", trend:"flat", note:"Release clause being activated", lastSeen:"2026-08-07T23:07:29Z", baseProb:85}
];
const DEAD = [
