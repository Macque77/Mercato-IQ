...
const INCOMING = [
  ...
  {name:"Matteo Ruggeri", sub:"22 · Italy · D", club:"Atlético Madrid", pos:"D", report:"Aston Villa secures Matteo Ruggeri's approval for transfer from Atlético Madrid", src:"Crypto Briefing", tier:3, fee:"Undisclosed", truth:80, prob:75, light:"g", trend:"flat", note:"Player approval confirmed; deal structure in place", lastSeen:"2026-08-08T10:03:39Z", baseProb:75, dead:true, deadReason:"Approval secured but no further progress; deal appears stalled or off"},
  ...
  {name:"Lamine Camara", sub:"24 · Senegal · Midfielder", club:"Mönchengladbach", pos:"Midfielder", report:"Aston Villa agree €21m deal for 24-year-old midfielder", src:"transferfeed", tier:2, fee:"€21m", truth:80, prob:75, light:"g", trend:"up", note:"Deal agreed in principle", lastSeen:"2026-08-08T11:19:01Z", baseProb:75},
...
const OUTGOING = [
  {name:"Ezri Konsa", sub:"26 · England · Defender", club:"Liverpool", pos:"Defender", report:"Liverpool set to rival Arsenal for Aston Villa and England defender", src:"Sky Sports", tier:2, fee:"Undisclosed", truth:70, prob:65, light:"g", trend:"flat", note:"Multiple clubs interested; transfer target", lastSeen:"2026-08-08T11:19:01Z", baseProb:65},
  {name:"Youri Tielemans", sub:"26 · Belgium · Midfielder", club:"Manchester United", pos:"Midfielder", report:"Manchester United set to finalise Youri Tielemans move from Aston Villa due to £35m release clause", src:"The Athletic", tier:1, fee:"£35m", truth:90, prob:85, light:"g", trend:"up", note:"Release clause being activated", lastSeen:"2026-08-08T11:19:01Z", baseProb:85}
];
const DEAD = [
...
const LINKMAP = {
  ...
  "Matteo Ruggeri": ["marcaRubenUriaMatteoRuggeri", "tEAMtalkrelayingFabrizioRomanoMatteoRuggeri", "transferfeedLamineCamara", "the4thOfficialMatteoRuggeri", "roundtableioMatteoRuggeri", "cryptoBriefingMatteoRuggeri"],
