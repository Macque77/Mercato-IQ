...
const INCOMING = [
  ...
  {name:"Matteo Ruggeri", sub:"24 · Italy · LB", club:"Atlético Madrid", pos:"LB", report:"Aston Villa have agreed a fee with Atlético Madrid for left-back Matteo Ruggeri", src:"roundtable.io", tier:3, fee:"Undisclosed", truth:75, prob:75, light:"g", trend:"down", note:"Final stages of deal; Villa targeting different left-back profile alongside this signing", lastSeen:"2026-08-07T06:16:29Z", baseProb:75, dead:true, deadReason:"No snippet support in provided feed"},
  ...
  {name:"Lamine Camara", sub:"24 · Senegal · CM", club:"AS Monaco", pos:"CM", report:"Aston Villa agree €21m deal for 24-year-old midfielder as final talks begin", src:"The 4th Official", tier:3, fee:"€21m", truth:70, prob:75, light:"g", trend:"flat", note:"Final negotiations underway; described as right profile for Emery", lastSeen:"2026-08-07T06:16:29Z", baseProb:75, dead:true, deadReason:"No fresh snippet support; existing page entry has no recent confirmation or update"},
  {name:"Alejandro Garnacho", sub:"20 · Argentina · W", club:"Chelsea", pos:"W", report:"Aston Villa agree deal with Chelsea for winger", src:"David Ornstein", tier:1, fee:"Undisclosed", truth:95, prob:85, light:"g", trend:"flat", note:"Deal agreed between clubs", lastSeen:"2026-08-07T10:18:48Z", baseProb:85}
];

const OUTGOING = [
  {name:"Ezri Konsa", sub:"26 · England · CB", club:"Aston Villa", pos:"CB", report:"Liverpool rival Arsenal for the defender; Villa adamant he is staying and willing to lose biggest name to keep him", src:"Sky Sports, Football365", tier:2, fee:"Unknown", truth:70, prob:25, light:"o", trend:"down", note:"Arsenal and Liverpool interested; Villa stated to be keeping him", lastSeen:"2026-08-07T10:18:48Z", baseProb:25},
  {name:"Youri Tielemans", sub:"27 · Belgium · CM", club:"Aston Villa", pos:"CM", report:"Manchester United set to finalise move due to £35m release clause", src:"David Ornstein", tier:1, fee:"£35m", truth:95, prob:90, light:"g", trend:"up", note:"Release clause activated; deal finalising", lastSeen:"2026-08-07T10:18:48Z", baseProb:90}
];
const DEAD = [
...
const LINKMAP = {
  "Lamine Camara": ["onefootball","yahoo","lequipe", "transferfeedLamineCamara", "the4thOfficialMatteoRuggeri"],
  ...
  "Alejandro Garnacho": ["fabrizioRomanoviaFootballTransfersAlejandroGarnacho", "skySportsAlejandroGarnacho", "theAthleticDavidOrnsteinAlejandroGarnacho"],
