...
const INCOMING = [
  {name:"Marcus Rashford", sub:"27 · England · W", club:"Manchester United", pos:"W", report:"Aston Villa exploring move for Manchester United winger", src:"Unknown", tier:3, fee:"Undisclosed", truth:50, prob:40, light:"y", trend:"up", note:"Recent rumour reported ~1 day ago", lastSeen:"2026-08-07T14:38:27Z", baseProb:40, dead:true, deadReason:"No recent credible reports; exploration stalled or abandoned"},
  {name:"Igor Paixão", sub:"26 · Brazil · W", club:"Fiorentina", pos:"W", report:"Villa exploring a move for the 26-year-old winger", src:"Unknown", tier:3, fee:"Undisclosed", truth:60, prob:50, light:"y", trend:"up", note:"Exploratory interest", lastSeen:"2026-08-07T14:38:27Z", baseProb:50, dead:true, deadReason:"No recent credible reports; exploration stalled or abandoned"},
  {name:"Matteo Ruggeri", sub:"22 · Italy · LB", club:"Atlético Madrid", pos:"LB", report:"Aston Villa have agreed a fee with Atlético Madrid", src:"Unknown", tier:3, fee:"Undisclosed", truth:75, prob:70, light:"g", trend:"down", note:"Fee agreed, deal progressing", lastSeen:"2026-08-07T14:38:27Z", baseProb:70, dead:true, deadReason:"No recent credible reports; fee agreement not progressed"},
  {name:"Zion Suzuki", sub:"21 · Japan · GK", club:"Parma", pos:"GK", report:"The Parma goalkeeper remains on Villa's list", src:"Unknown", tier:3, fee:"Undisclosed", truth:55, prob:45, light:"y", trend:"up", note:"Monitoring goalkeeper option", lastSeen:"2026-08-07T14:38:27Z", baseProb:45, dead:true, deadReason:"No recent credible reports; remains on list but inactive"},
  {name:"Lamine Camara", sub:"24 · Senegal · MF", club:"Monaco", pos:"MF", report:"Aston Villa agree €21m deal for 24-year-old midfielder", src:"Fabrizio Romano", tier:1, fee:"€21m", truth:90, prob:85, light:"g", trend:"up", note:"Deal agreed, final talks begin", lastSeen:"2026-08-07T14:38:27Z", baseProb:85, dead:true, deadReason:"Deal appears to have stalled; no confirmation or recent progress"},
  {name:"Alejandro Garnacho", sub:"20 · Spain · W", club:"Chelsea", pos:"W", report:"Aston Villa agree deal with Chelsea for winger", src:"David Ornstein", tier:1, fee:"Undisclosed", truth:85, prob:75, light:"g", trend:"flat", note:"Deal agreed with Chelsea", lastSeen:"2026-08-07T20:08:12Z", baseProb:75}
];

const OUTGOING = [
  {name:"Ezri Konsa", sub:"26 · England · D", club:"Aston Villa", pos:"D", report:"Liverpool set to rival Arsenal for Aston Villa defender", src:"Sky Sports", tier:2, fee:"Undisclosed", truth:65, prob:55, light:"g", trend:"down", note:"Interest from Liverpool and Arsenal", lastSeen:"2026-08-07T20:08:12Z", baseProb:55},
  {name:"Youri Tielemans", sub:"27 · Belgium · M", club:"Aston Villa", pos:"M", report:"Manchester United set to finalise move due to £35m release clause", src:"David Ornstein", tier:1, fee:"£35m", truth:90, prob:85, light:"g", trend:"flat", note:"Release clause being activated", lastSeen:"2026-08-07T20:08:12Z", baseProb:85}
];
const DEAD = [
