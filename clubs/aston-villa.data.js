...
const INCOMING = [
  {name:"Marcus Rashford", sub:"27 · England · W", club:"Manchester United", pos:"W", report:"Aston Villa exploring move for Manchester United winger", src:"Unknown", tier:3, fee:"Undisclosed", truth:45, prob:35, light:"y", trend:"down", note:"Early stage exploration", lastSeen:"2026-08-08T04:21:31Z", baseProb:35, dead:true, deadReason:"No fresh confirmation in recent snippets; no credible reporting in current window"},
  {name:"Igor Paixão", sub:"26 · Brazil · W", club:"Fiorentina", pos:"W", report:"Villa exploring a move for the 26-year-old winger", src:"Unknown", tier:3, fee:"Undisclosed", truth:55, prob:40, light:"y", trend:"down", note:"Early stage exploration", lastSeen:"2026-08-08T04:21:31Z", baseProb:40, dead:true, deadReason:"No fresh confirmation in recent snippets; no credible reporting in current window"},
  {name:"Matteo Ruggeri", sub:"20 · Italy · Left-back", club:"Atalanta", pos:"Left-back", report:"Aston Villa closing in on €20m Matteo Ruggeri deal", src:"Fabrizio Romano", tier:1, fee:"€20m", truth:90, prob:80, light:"g", trend:"up", note:"Villa secures player's approval", lastSeen:"2026-08-08T14:10:31Z", baseProb:80, dead:true, deadReason:"Snippet references €20m deal 'almost done' but no confirmation of completion or material progress in recent days"},
  {name:"Zion Suzuki", sub:"21 · Japan · GK", club:"Parma", pos:"GK", report:"The Parma goalkeeper remains on Villa's list", src:"Unknown", tier:3, fee:"Undisclosed", truth:50, prob:40, light:"y", trend:"down", note:"Target goalkeeper option", lastSeen:"2026-08-08T04:21:31Z", baseProb:40, dead:true, deadReason:"No fresh confirmation in recent snippets; no credible reporting in current window"},
  {name:"Lamine Camara", sub:"24 · Senegal · Midfielder", club:"AS Monaco", pos:"Midfielder", report:"Aston Villa agree €21m deal for 24-year-old midfielder", src:"Fabrizio Romano", tier:1, fee:"€21m", truth:95, prob:85, light:"g", trend:"up", note:"Deal described as 'almost done'", lastSeen:"2026-08-08T14:10:31Z", baseProb:85, dead:true, deadReason:"Snippet references €21m deal 'agreed' but no confirmation of completion or recent material update"},
  {name:"Alejandro Garnacho", sub:"20 · Spain · W", club:"Chelsea", pos:"W", report:"Aston Villa agree deal with Chelsea for winger", src:"David Ornstein", tier:1, fee:"Undisclosed", truth:85, prob:75, light:"g", trend:"flat", note:"Deal agreed between clubs", lastSeen:"2026-08-08T04:21:31Z", baseProb:75, dead:true, deadReason:"No fresh confirmation in recent snippets; no credible reporting in current window"},
  {name:"Jonathan Rowe", sub:"unknown · England · W", club:"Norwich City", pos:"W", report:"Jonathan Rowe to Aston Villa revived after John McGinn injury", src:"Read Aston Villa", tier:3, fee:"", truth:50, prob:45, light:"y", trend:"flat", note:"Transfer link revived following McGinn's injury", lastSeen:"2026-08-08T07:40:33Z", baseProb:45, dead:true, deadReason:"No recent credible snippet; move not advanced"},
  {name:"Youri Tielemans", sub:"26 · Belgium · Midfielder", club:"Manchester United", pos:"Midfielder", report:"Manchester United set to finalise Youri Tielemans move from Aston Villa due to £35m release clause", src:"David Ornstein", tier:1, fee:"£35m", truth:85, prob:75, light:"g", trend:"down", note:"Release clause confirmed by Ornstein", lastSeen:"2026-08-08T18:06:10Z", baseProb:75}
];

const OUTGOING = [
  {name:"Ezri Konsa", sub:"26 · England · Defender", club:"Aston Villa", pos:"Defender", report:"Liverpool set to rival Arsenal for Aston Villa and England defender Ezri Konsa", src:"Sky Sports", tier:2, fee:"Undisclosed", truth:65, prob:50, light:"y", trend:"down", note:"Arsenal and Liverpool both interested", lastSeen:"2026-08-08T18:06:10Z", baseProb:50},
  {name:"Youri Tielemans", sub:"26 · Belgium · Midfielder", club:"Aston Villa", pos:"Midfielder", report:"Manchester United set to finalise Youri Tielemans move from Aston Villa due to £35m release clause", src:"David Ornstein", tier:1, fee:"£35m", truth:85, prob:75, light:"g", trend:"down", note:"Release clause confirmed by Ornstein", lastSeen:"2026-08-08T18:06:10Z", baseProb:75}
];
const DEAD = [
...
const HUB = {
  ...
  davidOrnsteinTheAthleticYouriTielemans1: {l:"David Ornstein / The Athletic", u:"https://news.google.com/rss/articles/CBMiqwFBVV95cUxQU3lHaTE0RDBkRGJwdlRRVklLeXRnSU9Od211X1pIdWlJcGdEdzJ1Zy1QS3ZuT3QxWGV0NlhiVVYxdHlaR3lXTnBpMG5lUGFSd3BVMmFGenVxM2NpVjU0Tk95MUZ2RzNZLVBiczBfS2xQNWU5Z2dfTktTc3lweGR6ZVR4N3NTSV8zQk9xWFhUQXZ1M3cwcmptUDgtVVNNSXMybjROVlUwb3VWWTA"},
  readAstonVillaJonathanRowe: {l:"Read Aston Villa", u:"https://news.google.com/rss/articles/CBMiogFBVV95cUxQT3dvWTl1M1JPOTNFNlB2Q0ZkblVuWktnM2JzalZ1cVRoYjllOXZ1WGFtOTY4WXJ6a1kwWjctU2NhZWVpRGVhdWlwOTdiU1NlVDhnRElXcjZHY2tVb1dUc08xcDFfX0VvRF9ZM2tZenNzUndTRnNVbVpiakxCR1B1LWl4RndPbW56cUQtTnhSbnk4LTNKVjhtTkZzTmJDVmFNWlE"},
  cryptoBriefingMatteoRuggeri: {l:"Crypto Briefing", u:"https://news.google.com/rss/articles/CBMifEFVX3lxTFB3WmZCZ2RZcFA1blZfemlpWnBfZ0NmWjVwOXUtcC1wYUR4U1k4aEYzc0FTT1VrQTNNOGFncjJWR1kyVENoQmw3cGlBVVRoczRsd1hWTUNFcVgweFFZSG1GUlRUZ3lndzBvOTJRR3ZSQ2wwOENuRlFKREVqeVo"},
  caughtoffsidecomviaFabrizioRomanoLamineCamara: {l:"caughtoffside.com (via Fabrizio Romano)", u:"https://news.google."},
  theNewYorkTimesMatteoRuggeri: {l:"The New York Times", u:"https://news.google.com/rss/articles/CBMipwFBVV95cUxONy01eHk4Q3pOcXZhVGw1NVVMcEI0Ukg4dklMTVdaOFQwZzRUaXdjdGVIWlV0ZGF6cmpBWlM1dnUxbDdmZGIyWkdqNGdVcUpmVWs1Y2ZaN3BXY3gxT3FHWlYzRkVoTnBaS0dYN1AtYVFIbkdnSmJfUVF6Wkw2b3VJby1RTU1BelRNeThfWEFvV0RiaDRsZGpzQVBzOVFjbHZSWlNZZld5bw"},
  theAthleticDavidOrnsteinYouriTielemans1: {l:"The Athletic / David Ornstein", u:"https://www.nytimes.com"},
  skySportsEzriKonsa2: {l:"Sky Sports", u:"https://www.skysports.com"}};
const LINKMAP = {
  "Lamine Camara": ["onefootball","yahoo","lequipe", "transferfeedLamineCamara", "the4thOfficialMatteoRuggeri", "the4thOfficialLamineCamara", "caughtoffsidecomviaFabrizioRomanoLamineCamara"],
  ...
  "Ezri Konsa": ["readAstonVillaEzriKonsa", "sportsMoleEzriKonsa", "transferfeedLamineCamara", "skySportsEzriKonsa", "skySportsEzriKonsa1", "skySportsEzriKonsa2"],
  "Johan Manzambi": ["skySportsJohanManzambi"],
  "João Gomes": ["eSPNDailyPostJooGomes", "readAstonVillarelayingFabrizioRomanoJooGomes"],
  "Youri Tielemans": ["readAstonVillaMyOldManSaidMorganRogers", "davidOrnsteinTheAthleticYouriTielemans", "theAthleticTheNewYorkTimesDavidOrnsteinYouriTielemans", "theAthleticDavidOrnsteinYouriTielemans", "davidOrnsteinTheAthleticYouriTielemans1", "theAthleticDavidOrnsteinYouriTielemans1"],
  ...
  "Matteo Ruggeri": ["marcaRubenUriaMatteoRuggeri", "tEAMtalkrelayingFabrizioRomanoMatteoRuggeri", "transferfeedLamineCamara", "the4thOfficialMatteoRuggeri", "roundtableioMatteoRuggeri", "cryptoBriefingMatteoRuggeri", "theNewYorkTimesMatteoRuggeri"],
  "Zion Suzuki": ["tEAMtalkrelayingFabrizioRomanoZionSuzuki", "transferfeedLamineCamara"],
  "Jonathan Rowe": ["readAstonVillaJonathanRowe"]};
const WL_LINKMAP = {
