...
const INCOMING = [
  ...
  {name:"Matteo Ruggeri", sub:"unknown · Italy · LB", club:"Atlético Madrid", pos:"LB", report:"Aston Villa have agreed a fee with Atlético Madrid", src:"existing page", tier:2, fee:"Undisclosed", truth:75, prob:75, light:"g", trend:"up", note:"Fee agreed with Atlético Madrid", lastSeen:"2026-08-08T07:40:33Z", baseProb:75},
  ...
  {name:"Jonathan Rowe", sub:"unknown · England · W", club:"Norwich City", pos:"W", report:"Jonathan Rowe to Aston Villa revived after John McGinn injury", src:"Read Aston Villa", tier:3, fee:"", truth:50, prob:45, light:"y", trend:"flat", note:"Transfer link revived following McGinn's injury", lastSeen:"2026-08-08T07:40:33Z", baseProb:45}
];

const OUTGOING = [
  {name:"Ezri Konsa", sub:"26 · England · CB", club:"Aston Villa", pos:"CB", report:"Liverpool set to rival Arsenal for Aston Villa defender", src:"Sky Sports", tier:2, fee:"Undisclosed", truth:65, prob:50, light:"y", trend:"flat", note:"Liverpool emerge as rival to Arsenal for the England defender", lastSeen:"2026-08-08T07:40:33Z", baseProb:50},
  {name:"Youri Tielemans", sub:"27 · Belgium · M", club:"Manchester United", pos:"M", report:"Manchester United set to finalise move due to £35m release clause", src:"David Ornstein / The Athletic", tier:1, fee:"£35m", truth:90, prob:85, light:"g", trend:"flat", note:"Release clause confirmed; deal described as set to be finalised", lastSeen:"2026-08-08T07:40:33Z", baseProb:85}
];
const DEAD = [
