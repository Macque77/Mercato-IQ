...
const INCOMING = [
  {name:"Jay Fulton", sub:"MF", club:"Free agent", pos:"MF", report:"Incoming rumour", src:"FLW opinion", tier:0, fee:"Free", truth:30, prob:20, light:"o", trend:"down", note:"On-page rumour retained pending fresh snippet", lastSeen:"2026-08-08T18:06:10Z", baseProb:20},
  {name:"Munroe", sub:"", club:"", pos:"Striker", report:"Blackpool in talks for Munroe", src:"thestar.co.uk", tier:2, fee:"", truth:70, prob:65, light:"g", trend:"up", note:"Rivals reject new striker bid as Blackpool in talks", lastSeen:"2026-08-08T18:06:10Z", baseProb:65}
];
const OUTGOING = [
  {name:"Franco Ravizzoli", sub:"Unknown · Unknown · Unknown", club:"Blackpool", pos:"Unknown", report:"Linked with exit", src:"Unknown", tier:0, fee:"Undisclosed", truth:50, prob:45, light:"y", trend:"down", note:"On-page rumour retained pending fresh snippet", lastSeen:"2026-08-08T18:06:10Z", baseProb:45},
  {name:"Josh Bowler", sub:"Unknown · Unknown · Unknown", club:"Blackpool", pos:"Unknown", report:"Linked with exit", src:"Unknown", tier:0, fee:"Undisclosed", truth:50, prob:45, light:"y", trend:"down", note:"On-page rumour retained pending fresh snippet", lastSeen:"2026-08-08T18:06:10Z", baseProb:45},
...
const HUB = {
  ...
  thestarcoukMunroe2: {l:"thestar.co.uk", u:"https://news.google."},
  thestarcoukMunroe3: {l:"thestar.co.uk", u:"https://news.google.?oc=5"}};
...
const LINKMAP = {
  ...
  "Munroe": ["thestarcoukMunroe", "thestarcoukMunroe1", "thestarcoukMunroe2", "thestarcoukMunroe3"]};
const WL_LINKMAP = {};
