...
const OUTGOING = [
  {name:"Mathys Detourbet", sub:"18 · W · France", club:"Manchester City", pos:"W", report:"3 Jan 2026", src:"Get French Football News", tier:2, fee:"TBD", truth:52, prob:28, light:"o", trend:"flat", note:"Manchester City reported to be leading the race for the teenage prospect since the turn of the year; the interest has carried into the summer window."}
];
