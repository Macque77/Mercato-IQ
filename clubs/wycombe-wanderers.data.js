...
const CONFIRMED_OUT = [];
const INCOMING = [
  {name:"Joel Randall", sub:"FW", club:"Free agent (released by Bolton)", pos:"FW", report:"Joel Randall joins Wycombe Wanderers", src:"Various", tier:0, fee:"Free", truth:40, prob:30, light:"y", trend:"down", note:"On-page entry retained; no fresh snippet data", lastSeen:"2026-08-08T18:06:11Z", baseProb:30},
  ...
  {name:"Aaron Morley", sub:"Unknown · Unknown · Unknown", club:"Bolton Wanderers", pos:"Unknown", report:"Joins from Bolton Wanderers", src:"bwfc.co.uk", tier:2, fee:"Unknown", truth:100, prob:100, light:"g", trend:"flat", note:"Confirmed by Bolton official source", lastSeen:"2026-08-08T18:06:11Z", baseProb:100},
...
const OUTGOING = [
  {name:"Fred Onyedinma", sub:"Unknown · Unknown · Unknown", club:"Wycombe Wanderers", pos:"Unknown", report:"Discussions ongoing regarding departure", src:"Bucks Free Press", tier:3, fee:"Unknown", truth:65, prob:50, light:"y", trend:"flat", note:"Active discussions confirmed", lastSeen:"2026-08-08T18:06:11Z", baseProb:50}
];
const RISERS = [];
const FALLERS = [];
const NEW = [];
...
const HUB = {
  ...
  bucksFreePressFredOnyedinma2: {l:"Bucks Free Press", u:"https://news.google.com/rss/articles/CBMiogFBVV95cUxOUEJKejZlZXVSQ3BPSXNaZ0dMSHR4ejlKTUxtTlQ5TmZVOWl4b0FYeXdDTXBKUkJVTWZIOGwwZnprNVJvSm5pZzAyN0ctS0lESVgzXzJ4YnNqVFJRSmFSVzFpZlRzLUpJcjRFdGxmOWFQbmMzNTMzVWpkZXRDX1RUUF9PMVJUMkZwZEQ3bk5vUUo1NXo0Nk1CSlhDRy1WcFdhOHc?oc=5"},
  belfastTelegraphConorHazard1: {l:"Belfast Telegraph", u:"https://news.google.?oc=5"},
  bBCMattMacey2: {l:"BBC", u:"https://news.google.com/rss/articles/CBMiZ0FVX3lxTFBVZndST00yT3otQS1OWUVuSm82M1VMMEtCc0RyZHlCQ1V0MG0yVGxNWEpPcno4QXZuMFo2UXFyV2oxQ040RkgtbHA0cUx4dG1pdVZOUWhzU2tSUEQ2Z05SckJDYjhDSjA?oc=5"}};

const LINKMAP = {
  "Joel Randall": ["gnews-joelrandall"],
  "Conor Hazard": ["gnews-conorhazard", "belfastTelegraphConorHazard", "bBCConorHazard", "bBCSportConorHazard", "belfastTelegraphConorHazard1"],
  "Fred Onyedinma": ["gnews-fredonyedinma", "bucksFreePressFredOnyedinma", "bucksFreePressFredOnyedinma1", "bucksFreePressFredOnyedinma2"],
  "Aaron Morley": ["boltonWanderersFCAaronMorley", "boltonWanderersFCAaronMorley1", "boltonWanderersFCAaronMorley2"],
  "Matt Macey": ["bBCMattMacey", "bBCMattMacey1", "bBCSportConorHazard", "bBCMattMacey2"],
