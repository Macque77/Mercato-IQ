...
const INCOMING = [
  ...
  {name:"Jonathan David", sub:"ST · Canada", club:"Juventus", pos:"ST", report:"~2 days ago", src:"TEAMtalk", tier:3, fee:"Loan", truth:53, prob:28, light:'o', trend:'up',
   note:"Juventus are prepared to approve a loan exit and Leeds are interested, a high-profile fix for the No.9 need. Obstacle: a loan only (no resale upside), wages, and 'amid interest from others' means a competitive field. No T1 confirmation."},
  ...
  {name:"Shea Charles", sub:"DM · Northern Ireland", club:"Southampton", pos:"DM", report:"~1 day ago", src:"Aggregated", tier:3, fee:"£10-15m", truth:50, prob:25, light:'o', trend:'up',
   note:"Leeds remain interested after Southampton's play-off exit: young, British, a holding-midfield profile that fits. Obstacle: T3 sourcing only, valuation, and no progression to talks reported yet."},
  {name:"Lutsharel Geertruida", sub:"25 · Netherlands", club:"RB Leipzig", pos:"CB/RB", report:"~2 days ago", src:"S. Vidal / YEP", tier:3, fee:"£17-20m", truth:47, prob:22, light:'o', trend:'flat',
   note:"Leeds are 'hoping to sign' the versatile Dutch defender. KEY OBSTACLE: Sunderland reportedly hold a purchase option on the same player from his loan spell, a direct, inside-track competitor. Leeds would likely need to act decisively or miss out."},
  {name:"Liam Delap", sub:"ST · England", club:"Chelsea", pos:"ST", report:"~10 days ago", src:"Simon Phillips", tier:3, fee:"£25-30m", truth:45, prob:20, light:'o', trend:'flat',
   note:"Chelsea have indicated the English centre-forward is available. On-profile (young, British, resale). Obstacle: Chelsea's price, his wages, and Leeds are one of several clubs, no concrete bid."},
  {name:"Harvey Elliott", sub:"AM/W · England", club:"Liverpool", pos:"AM/W", report:"~2 days ago", src:"Football Insider", tier:3, fee:"£20-25m", truth:45, prob:20, light:'o', trend:'up',
   note:"Fresh link for the Liverpool creator seeking minutes, a clear quality and resale profile. Obstacle: Football Insider-tier sourcing, a likely crowded race for a player of his profile, and price."},
...
const OUTGOING = [
  {name:"Joel Piroe", sub:"ST · Netherlands", club:"PSV / Boro / Rangers / Ipswich", pos:"ST", report:"~3 days ago", src:"TEAMtalk", tier:3, fee:"£8-10m", truth:83, prob:58, light:'g', trend:'up',
   note:"The clearest sale: Leeds are READY TO SELL at £8-10m and the suitor list is long (PSV, Middlesbrough, Rangers, Stoke, Birmingham, Ipswich). PRICING: a willing seller plus a short contract horizon caps the fee, this is a buyers' market, not a holder's price."},
  {name:"Joe Gelhardt", sub:"ST · England", club:"Hull / Rangers / Celtic", pos:"ST", report:"~9h ago", src:"Aggregated", tier:3, fee:"£4-8m / loan", truth:75, prob:50, light:'y', trend:'up',
   note:"One year left on his deal, so a decision is forced this window. Newly-promoted Hull could pay a fee; Rangers' move is described as 'difficult'; Celtic also keen. The short contract erodes Leeds' leverage."},
  {name:"Ao Tanaka", sub:"27 · Japan · CM", club:"Newcastle / Everton / Bundesliga", pos:"CM", report:"~4 wks", src:"F. Plettenberg", tier:3, fee:"£12-18m", truth:70, prob:45, light:'y', trend:'up',
   note:"Open to leaving after reduced minutes, with a long suitor list (Newcastle, Everton, Man Utd checks, plus Freiburg, Union Berlin, Southampton). PRICING: PL/Bundesliga demand holds a floor, but a player pushing to go softens it. A sale would trigger a midfield buy (Hackney/Charles)."},
  {name:"Illan Meslier", sub:"GK · France", club:"Birmingham / Championship", pos:"GK", report:"~5 days ago", src:"Aggregated", tier:3, fee:"£5-10m", truth:70, prob:45, light:'y', trend:'up',
   note:"Expected to leave Elland Road after losing the No.1 spot; Birmingham could move for a fee. His exit is the trigger for the goalkeeper hunt (Trafford/Pope/Rushworth)."},
  {name:"Wilfried Gnonto", sub:"W · Italy", club:"SC Freiburg", pos:"W", report:"~2 days ago", src:"S. Vidal", tier:3, fee:"£20-28m", truth:65, prob:40, light:'y', trend:'up',
   note:"Freiburg are keen and Leeds have SET a transfer fee, a holder's stance on a genuine resale asset. PRICING: still a saleable talent, so the price is firm; an exit here is the most likely funder of a 'blockbuster' incoming."},
  {name:"Jack Harrison", sub:"W · England", club:"Fiorentina", pos:"W", report:"~5 wks", src:"Aggregated", tier:3, fee:"€8m option", truth:65, prob:40, light:'y', trend:'flat',
   note:"On loan at Fiorentina with an ~€8m permanent option; the player has said he is happy in Florence. A clean, likely permanent exit that clears wages."},
  {name:"Largie Ramazani", sub:"W · DR Congo/Belgium", club:"Valencia", pos:"W", report:"~3 wks", src:"Football media", tier:3, fee:"£8-12m", truth:63, prob:38, light:'y', trend:'flat',
   note:"On loan at Valencia, where he has impressed (6 goals); a permanent move or fresh loan is the likely outcome. Squad-trimming that helps SCR headroom."},
  {name:"Lucas Perri", sub:"GK · Brazil", club:"Brazilian clubs", pos:"GK", report:"~6 wks", src:"Jorge Nicola", tier:3, fee:"£6-10m", truth:55, prob:30, light:'y', trend:'flat',
   note:"A summer exit is being considered, with Brazilian clubs understood to be interested. Part of clearing a crowded goalkeeping department."},
  {name:"Mateo Joseph", sub:"22 · Spain · ST", club:"Mallorca / Leicester / Wrexham", pos:"ST", report:"~4 wks", src:"TEAMtalk", tier:3, fee:"£6-10m", truth:50, prob:25, light:'o', trend:'down',
   note:"Leeds were prepared to sanction a sale, but an ACL injury has stalled momentum and weakened any fee. Likely to stay until fit unless a buyer gambles."},
  {name:"Pascal Struijk", sub:"CB · Netherlands", club:"Aston Villa / Newcastle / Spurs", pos:"CB", report:"~4 wks", src:"Football Insider", tier:3, fee:"£30m+ (resisting)", truth:40, prob:15, light:'o', trend:'down',
   note:"Villa, Newcastle and Spurs are all credited with interest, BUT Farke has told the board Struijk should NOT be sold. PRICING: a key player Leeds will price prohibitively, the high ask is designed to deter, not invite."},
];
...
const LINKMAP = {
  ...
  "Lucas Perri": ["leedslive"],
  "Mateo Joseph": ["teamtalk"],
  "Pascal Struijk": ["fInsider","yep"],
...
`,
  ...
  methodLegend: `
      ...
      <div class="col">
        ...
        <div class="row" style="margin-top:10px"><span class="k" style="color:var(--gold)">NB</span><span>Recycled aggregator repetition does <b>not</b> refresh recency. Parrott &amp; Hadj Moussa fall on this basis.</span></div>
