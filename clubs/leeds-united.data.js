...
const INCOMING = [
  ...
  {name:"Jonathan David", sub:"ST · Canada", club:"Juventus", pos:"ST", report:"~2 days ago", src:"TEAMtalk", tier:3, fee:"Loan", truth:53, prob:28, light:'o', trend:'up',
   note:"Juventus are prepared to approve a loan exit and Leeds are interested, a high-profile fix for the No.9 need. Obstacle: a loan only (no resale upside), wages, and 'amid interest from others' means a competitive field. No T1 confirmation.", lastSeen:"2026-08-04T19:10:50Z", baseProb:28, dead:true, deadReason:"No recent snippet support; unclear status"},
  ...
  {name:"Shea Charles", sub:"DM · Northern Ireland", club:"Southampton", pos:"DM", report:"~1 day ago", src:"Aggregated", tier:3, fee:"£10-15m", truth:50, prob:25, light:'o', trend:'up',
   note:"Leeds remain interested after Southampton's play-off exit: young, British, a holding-midfield profile that fits. Obstacle: T3 sourcing only, valuation, and no progression to talks reported yet.", lastSeen:"2026-08-04T19:10:50Z", baseProb:25, dead:true, deadReason:"No recent snippet support; unclear status"},
  {name:"Lutsharel Geertruida", sub:"25 · Netherlands", club:"RB Leipzig", pos:"CB/RB", report:"~2 days ago", src:"S. Vidal / YEP", tier:3, fee:"£17-20m", truth:47, prob:22, light:'o', trend:'flat',
   note:"Leeds are 'hoping to sign' the versatile Dutch defender. KEY OBSTACLE: Sunderland reportedly hold a purchase option on the same player from his loan spell, a direct, inside-track competitor. Leeds would likely need to act decisively or miss out.", lastSeen:"2026-08-04T19:10:50Z", baseProb:22, dead:true, deadReason:"No recent snippet support; unclear status"},
  {name:"Liam Delap", sub:"ST · England", club:"Chelsea", pos:"ST", report:"~10 days ago", src:"Simon Phillips", tier:3, fee:"£25-30m", truth:45, prob:20, light:'o', trend:'flat',
   note:"Chelsea have indicated the English centre-forward is available. On-profile (young, British, resale). Obstacle: Chelsea's price, his wages, and Leeds are one of several clubs, no concrete bid.", lastSeen:"2026-08-04T19:10:50Z", baseProb:20, dead:true, deadReason:"No recent snippet support; unclear status"},
  ...
  {name:"James Trafford", sub:"Goalkeeper · England", club:"Manchester City", pos:"GK", report:"Joins from Manchester City", src:"BBC", tier:2, fee:"Up to £45m", truth:100, prob:100, light:"g", trend:"flat", note:"Deal confirmed", lastSeen:"2026-08-08T18:06:10Z", baseProb:100}
];
...
const OUTGOING = [
  {name:"Joel Piroe", sub:"ST · Netherlands", club:"PSV / Boro / Rangers / Ipswich", pos:"ST", report:"~3 days ago", src:"TEAMtalk", tier:3, fee:"£8-10m", truth:83, prob:58, light:'g', trend:'up',
   note:"The clearest sale: Leeds are READY TO SELL at £8-10m and the suitor list is long (PSV, Middlesbrough, Rangers, Stoke, Birmingham, Ipswich). PRICING: a willing seller plus a short contract horizon caps the fee, this is a buyers' market, not a holder's price.", lastSeen:"2026-08-04T19:10:50Z", baseProb:58, dead:true, deadReason:"No recent snippet support; unclear status"},
  {name:"Joe Gelhardt", sub:"ST · England", club:"Hull / Rangers / Celtic", pos:"ST", report:"~9h ago", src:"Aggregated", tier:3, fee:"£4-8m / loan", truth:75, prob:50, light:'y', trend:'up',
   note:"One year left on his deal, so a decision is forced this window. Newly-promoted Hull could pay a fee; Rangers' move is described as 'difficult'; Celtic also keen. The short contract erodes Leeds' leverage.", lastSeen:"2026-08-04T19:10:50Z", baseProb:50, dead:true, deadReason:"No recent snippet support; unclear status"},
  ...
  {name:"Wilfried Gnonto", sub:"W · Italy", club:"SC Freiburg", pos:"W", report:"~2 days ago", src:"S. Vidal", tier:3, fee:"£20-28m", truth:65, prob:40, light:'y', trend:'up',
   note:"Freiburg are keen and Leeds have SET a transfer fee, a holder's stance on a genuine resale asset. PRICING: still a saleable talent, so the price is firm; an exit here is the most likely funder of a 'blockbuster' incoming.", lastSeen:"2026-08-04T19:10:50Z", baseProb:40, dead:true, deadReason:"No recent snippet support; unclear status"},
  ...
  {name:"Karl Darlow", sub:"Goalkeeper · England", club:"Manchester United", pos:"GK", report:"Signs with Manchester United after Leeds exit", src:"The Athletic", tier:2, fee:"Undisclosed", truth:100, prob:100, light:"g", trend:"flat", note:"Deal confirmed", lastSeen:"2026-08-08T18:06:10Z", baseProb:100},
  {name:"Lucas Perri", sub:"Goalkeeper · Brazil", club:"Torino", pos:"GK", report:"Signing with Torino from Leeds United", src:"Unknown", tier:3, fee:"Undisclosed", truth:100, prob:100, light:"g", trend:"flat", note:"Deal confirmed", lastSeen:"2026-08-08T18:06:10Z", baseProb:100}
];
const DEAD = [
...
const WATCHLIST = [
  {name:"Haris Tabakovic", club:"Hoffenheim", pos:"ST", dir:"in", age:"~1d", tier:4, note:"Hoffenheim want to sell the Bosnian striker a year early, a cheaper No.9 option among many.", dead:true, deadReason:"No recent snippet support; unclear status"},
  {name:"Leo Scienza", club:"Southampton", pos:"W", dir:"in", age:"~1d", tier:4, note:"Impressed for Saints in 25/26; speculative wide link.", dead:true, deadReason:"No recent snippet support; unclear status"},
  {name:"Zian Flemming", club:"Burnley", pos:"ST", dir:"in", age:"~11d", tier:4, note:"Dutch forward, 10 PL goals for relegated Burnley; value striker option.", dead:true, deadReason:"No recent snippet support; unclear status"},
  {name:"Mikey Moore", club:"Tottenham", pos:"W", dir:"in", age:"~3d", tier:4, note:"Pundit (Keith Wyness) suggestion of a loan, no concrete club source.", dead:true, deadReason:"No recent snippet support; unclear status"},
  {name:"Finn Azaz", club:"Southampton", pos:"AM", dir:"in", age:"~3d", tier:4, note:"Linked to strengthen the attacking midfield; thin sourcing.", dead:true, deadReason:"No recent snippet support; unclear status"},
  {name:"Tammy Abraham", club:"Aston Villa", pos:"ST", dir:"in", age:"~5d", tier:3, note:"Villa signed him five months ago but an early exit is on the cards; Sunderland and Everton also considering. A proven-PL No.9 option in the striker hunt.", dead:true, deadReason:"No recent snippet support; unclear status"},
  {name:"Ladislav Krejci", club:"(Czechia)", pos:"CB", dir:"in", age:"~7d", tier:3, note:"TEAMtalk: Leeds prepared to move for the World-Cup-bound defender despite competition. A centre-back option to settle the loan army.", dead:true, deadReason:"No recent snippet support; unclear status"},
  {name:"Yassine Titraoui", club:"Charleroi", pos:"DM/CM", dir:"in", age:"~2d", tier:4, note:"Cross-link: Leeds floated alongside Sunderland (the stronger suitor) and Marseille for the young Algerian. Early, low-confidence.", dead:true, deadReason:"No recent snippet support; unclear status"},
  {name:"Wilson Isidor", club:"Sunderland", pos:"ST", dir:"in", age:"~13d", tier:3, note:"Cross-link: Leeds monitoring the striker Sunderland may sell, keen to leave Wearside after reduced minutes.", dead:true, deadReason:"No recent snippet support; unclear status"},
  {name:"Beto", club:"Everton", pos:"ST", dir:"in", age:"~13d", tier:4, note:"Re-linked a year on; another body in the striker market.", dead:true, deadReason:"No recent snippet support; unclear status"},
  {name:"Axel Disasi", club:"Chelsea", pos:"CB", dir:"in", age:"~13d", tier:3, note:"Football Insider: Leeds expect to lead the race if he is made available.", dead:true, deadReason:"No recent snippet support; unclear status"},
  {name:"Nick Pope", club:"Newcastle", pos:"GK", dir:"in", age:"~13d", tier:4, note:"Farke reportedly weighing a £5-10m move, an experienced GK alternative to Trafford.", dead:true, deadReason:"No recent snippet support; unclear status"},
  {name:"Dmytro Riznyk", club:"Shakhtar", pos:"GK", dir:"in", age:"~9d", tier:4, note:"A 'serious interest' GK link; approach reported, little corroboration.", dead:true, deadReason:"No recent snippet support; unclear status"},
  ...
  {name:"Gustavo Hamer", club:"Sheffield Utd", pos:"MF", dir:"in", age:"~3 wks", tier:4, note:"Sports Boom: monitoring the creative midfielder's situation.", dead:true, deadReason:"No recent snippet support (3+ weeks old)"},
  {name:"Wilfried Gnonto", club:"SC Freiburg", pos:"W", dir:"out", age:"~2d", tier:3, note:"(Also in main table.) Freiburg target; Leeds have set a fee.", dead:true, deadReason:"No recent snippet support; unclear status"},
  ...
  {name:"Sam Byram", club:"(seeking club)", pos:"DF", dir:"out", age:"~9d", tier:4, note:"Just 85 minutes all season; a likely free-agent-style departure.", dead:true, deadReason:"No recent snippet support; unclear status"}
];
...
const LINKMAP = {
  ...
  "Lucas Perri": ["leedslive", "leedsAllOverLucasPerri", "mOTLeedsNewsLucasPerri", "bBCJamesTrafford"],
  ...
  "Karl Darlow": ["tSNKarlDarlow", "theAthleticKarlDarlow", "bBCJamesTrafford"]};
const WL_LINKMAP = {
