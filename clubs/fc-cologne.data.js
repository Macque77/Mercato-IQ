...
const CONFIRMED_IN = [
  ...
  {name:"Gideon Mensah", sub:"Ghana international left-back", club:"AJ Auxerre", pos:"LB", fee:"Undisclosed", free:false, status:"done", statusTxt:"DONE, OFFICIAL", note:"Joined 11 July 2026 after impressing at the 2026 World Cup; took the No.14 shirt previously worn by club legend Jonas Hector."},
  {name:"Paul Okon-Engstler", sub:"Australian midfielder", club:"A-League club", pos:"CM", fee:"Undisclosed", free:false, status:"done", statusTxt:"DONE, OFFICIAL", note:"21-year-old signed 25 July 2026."},
  {name:"Martin James", sub:"French youth international", club:"Paris-based club", pos:"CM", fee:"Undisclosed", free:false, status:"done", statusTxt:"DONE, OFFICIAL", note:"18-year-old signed 24 July 2026, relocated from Paris."}
];
...
const HUB = {
  ...
  bundesligacomGideonMensah: {l:"Bundesliga.com", u:"https://www.bundesliga.com/en/bundesliga/clubs/1-fc-koeln/news"}};

const LINKMAP = {
  "Mateo Kvasina": ["skydeutschland"],
  "Mikey Moore": ["hardtackle"],
  "Said El Mala": ["teamtalk"],
  "Gideon Mensah": ["bundesligacomGideonMensah"],
  "Reigan Heskey": ["bundesligacomGideonMensah"],
  "Paul Okon-Engstler": ["bundesligacomGideonMensah"],
  "Martin James": ["bundesligacomGideonMensah"],
  "Jakub Kamiński": ["bundesligacomGideonMensah"]};
const WL_LINKMAP = {
  "Said El Mala": ["teamtalk"]
};
