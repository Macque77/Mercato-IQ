...
const INCOMING = [
  {name:"Reggie Walsh", sub:"MF", club:"Chelsea", pos:"MF", report:"~2 days ago", src:"Alan Nixon", tier:3, fee:"Loan", truth:75, prob:75, light:'g', trend:'up', note:"Loan expected to complete ahead of the deadline.", lastSeen:"2026-08-04T19:10:50Z", baseProb:75, dead:true, deadReason:"No fresh snippet support; stale entry (2 days old, no confirmation or materiality)"},
  {name:"Joe Walsh", sub:"DF", club:"QPR", pos:"DF", report:"~1 wk ago", src:"Various", tier:3, fee:"Undisclosed", truth:60, prob:55, light:'g', trend:'up', note:"Wigan reportedly closing in on the capture.", lastSeen:"2026-08-04T19:10:50Z", baseProb:55, dead:true, deadReason:"No fresh snippet support; stale entry (1 week old, no confirmation or materiality)"},
...
const HUB = {
  ...
  bBCHarrisonBettoni1: {l:"BBC", u:"https://news.google.com/rss/articles/CBMiZ0FVX3lxTE02aGppV2ctcUxpZ21zQ0dvSnFOcml4TTZYNUp0UzRrUFFCZkxMN1JmSU5QY3liZ0JEYlYxakp4TWxtME5TWEJIMFA4aUFGX092VHBOSXM2RnpkSmx0N0FmaktBV0JvTXM?oc=5"}};
...
const LINKMAP = {
  ...
  "Harrison Bettoni": ["bBCHarrisonBettoni", "weAintGotNoHistoryHarrisonBettoni", "weAintGotNoHistoryHarrisonBettoni1", "bBCHarrisonBettoni1"],
