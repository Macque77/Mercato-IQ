...
const SWEEP = {
  ...
  queries: ["valencia transfer news"]
};
...
const PROSE = {
  heroH2: `Valencia · 2026/27 Season`,
  heroLede: `Transfer window active. Valencia preparing squad for next season.`,
