...
const CONFIRMED_IN = [
  ...
  {name:"Lewis Smith", sub:"26 · Scotland · AM", club:"Livingston", pos:"AM", fee:"Undisclosed", free:false, status:"done", statusTxt:"DONE, OFFICIAL", note:"Signed and thrown straight in, starting against Brora Rangers in the Premier Sports Cup a day after joining. Robinson said Smith himself was surprised to start, with two departures and injuries in that area of the pitch. Fee undisclosed."}
];
const CONFIRMED_OUT = [];
const INCOMING = [
...
const HUB = {
  ...
  pressandJournalMariusMller: {l:"Press and Journal", u:"https://www.pressandjournal.co.uk/fp/sport/football/aberdeen-fc/7035089/aberdeen-fc-summer-transfer-window-live-blog/"}};
...
const LINKMAP = {
  ...
  "Ayoub Mouloua": ["gnews-ayoubmouloua", "pressandJournalMariusMller"],
  "Marius Müller": ["pressandJournalMariusMller"],
  "Lewis Smith": ["pressandJournalMariusMller"]};
const WL_LINKMAP = {};
