...
const INCOMING = [
  {name:"Lewis Hall", sub:"21 · England · LB", club:"Newcastle United", pos:"LB", report:"INEOS willing to pay £60m to sign Newcastle left-back; Ornstein confirms ongoing pursuit", src:"David Ornstein", tier:1, fee:"£60m", truth:75, prob:60, light:"g", trend:"down", note:"Multiple reports confirm Man Utd interest and INEOS willingness to fund move", lastSeen:"2026-08-08T18:06:10Z", baseProb:60},
  {name:"Moussa Baleba", sub:"20 · Senegal · CM", club:"Newcastle United", pos:"CM", report:"Man Utd target suffers injury that will rule him out for start of season", src:"David Ornstein", tier:1, fee:"Undisclosed", truth:50, prob:30, light:"y", trend:"down", note:"Injury concern diminishes likelihood of summer move; timeline unclear", lastSeen:"2026-08-08T18:06:10Z", baseProb:30},
...
const OUTGOING = [
  {name:"Marcus Rashford", sub:"26 · England · RW", club:"Manchester United", pos:"RW", report:"£40m exit clause expires; summer departure now unlikely as clause window closes", src:"David Ornstein", tier:1, fee:"£40m (clause expired)", truth:85, prob:15, light:"o", trend:"down", note:"Exit clause has passed; move away in summer now highly improbable", lastSeen:"2026-08-08T18:06:10Z", baseProb:15}
];
const DEAD = [
...
const LINKMAP = {
  ...
  "Moussa Baleba": ["tribalFootballviaDavidOrnsteinMoussaBaleba", "tribalFootballOrnsteinMoussaBaleba"],
