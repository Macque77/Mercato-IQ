...
const LINKMAP = {
  ...
  "Youri Tielemans": ["manUtdNews","teamtalkMUFC"],
  "Karl Darlow": ["manUtdNews"],
  "Tynan Thompson": ["manUtdNews","strettyNews"],
  "Rasmus Højlund": ["espnMUFC","manUtdNews"],
  "Jadon Sancho": ["espnMUFC"],
  "Casemiro": ["espnMUFC"],
  "Tyrell Malacia": ["espnMUFC"],
  "André Onana": ["manUtdNews"],
