...
const INCOMING = [
  {name:"Ousmane Diomande", sub:"22 · Ivory Coast · CB", club:"Sporting CP", pos:"CB", report:"Forest are in advanced talks and have agreed personal terms with the Ivory Coast centre back, having tabled a proposal worth around £30m. Sporting want a package closer to £40m plus bonuses and a sell-on share, with the final fee reported at about £34m. Oliver Glasner sees him as a starter in a back three.", src:"Fabrizio Romano / The Athletic", tier:1, fee:"£34m", truth:90, prob:80, light:"g", trend:"flat", note:"Completion has been called imminent for more than a week without an official Forest announcement verified here, so the 'done deal' framing is running ahead of the paperwork. Separate Diomande-to-Real Madrid headlines circulating this week concern RB Leipzig's Yan Diomande, a different player.", lastSeen:"2026-08-06T10:49:40Z", baseProb:80},
  ...
  {name:"Tijjani Reijnders", sub:"28 · Netherlands · CM", club:"Manchester City", pos:"CM", report:"Forest have turned their attention to the Dutch midfielder as they look to reinvest the Elliot Anderson money and fill the gap in midfield. Reijnders lost his place at City last season and could move before the new campaign starts.", src:"Fabrizio Romano", tier:1, fee:"Undisclosed", truth:70, prob:30, light:"y", trend:"down", note:"Interest only, relayed second hand from Romano rather than any club-to-club talks. No fee, no structure, no player position established, so treat as an early-stage sounding rather than a deal.", lastSeen:"2026-08-06T10:49:40Z", baseProb:30}
];
