...
const INCOMING = [
  ...
  {name:"Jaze Kabia", sub:"Unknown · Cork · Unknown", club:"Cork City", pos:"Unknown", report:"Leyton Orient sign Jaze Kabia in club-record deal", src:"BBC", tier:2, fee:"Club-record", truth:100, prob:100, light:"g", trend:"flat", note:"Record signing for the club", lastSeen:"2026-08-07T23:07:30Z", baseProb:100}
];
const OUTGOING = [
  {name:"Dom Ballard", sub:"Unknown · Unknown · Striker", club:"Bristol City", pos:"FW", report:"Bristol City closing in on Dom Ballard signing with Leyton Orient striker at Robins HPC", src:"Bristol Live", tier:2, fee:"~£5m", truth:85, prob:80, light:"g", trend:"flat", note:"Advanced talks; striker at medical", lastSeen:"2026-08-07T23:07:30Z", baseProb:80}
];
const RISERS = [];
const FALLERS = [];
const NEW = [];
