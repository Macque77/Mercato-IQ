...
const INCOMING = [
  ...
  {name:"Joel Veltman", sub:"34 · Netherlands · RB", club:"Free agent (ex-Brighton)", pos:"RB", report:"The Dutch defender, a free agent since leaving Brighton when his contract expired in July, is closing on a Bosman move to the London Stadium. Reports in the Netherlands say he was heading for a medical, and contract details have since emerged. It would be West Ham's first significant business of a Championship summer.", src:"Voetbal International; Chris Reidy (Sky Sports)", tier:2, fee:"Free", truth:80, prob:75, light:"g", trend:"flat", note:"Dutch-media led with no West Ham announcement yet. At 34 and on a short deal, terms rather than the transfer itself are the sticking point, so treat the medical claim with care until the club confirms.", lastSeen:"2026-08-06T08:09:17Z", baseProb:75}
];
const OUTGOING = [];
const RISERS = [
...
const LINKMAP = {
  ...
  "Joel Veltman": ["voetbalInternationalJoelVeltman"]};
const WL_LINKMAP = {};
