...
const INCOMING = [
  {name:"Simon Adingra", sub:"24 · LW · Ivory Coast", club:"Sunderland", pos:"LW", report:"3 Aug 2026", src:"Keith Downie / Sky Sports", tier:1, fee:"Loan (poss. obligation to buy)", truth:60, prob:42, light:"y", trend:"up", note:"West Ham opened loan talks as a direct replacement following Summerville's sale; Sunderland value the winger at around £30m and are yet to agree terms."},
  {name:"Wilson Isidor", sub:"25 · ST · Haiti", club:"Sunderland", pos:"ST", report:"3 Aug 2026", src:"Keith Downie / Sky Sports", tier:2, fee:"~£20m loan-to-buy approach reported", truth:48, prob:22, light:"o", trend:"flat", note:"Downie reports Sunderland will not entertain offers, calling Isidor integral to their Europa League squad - directly contradicted same-day by reports of a fresh West Ham loan-to-buy approach, a genuinely live and unresolved situation."},
  {name:"Troy Parrott", sub:"24 · ST · Republic of Ireland", club:"AZ Alkmaar", pos:"ST", report:"3 Aug 2026", src:"Alan Nixon (The72)", tier:2, fee:"Undisclosed", truth:42, prob:20, light:"o", trend:"flat", note:"West Ham have joined a crowded field (also including Fulham, Ajax, Como, Real Betis, PSV) as competition for striker Taty Castellanos."}
];
const OUTGOING = [];
const RISERS = [
