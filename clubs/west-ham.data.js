...
const INCOMING = [
  ...
  {name:"Arne Engels", sub:"20 · Belgium · Midfielder", club:"Celtic", pos:"Midfielder", report:"West Ham address interest in Arne Engels as Celtic deliver clear stance", src:"GlasgowWorld", tier:3, fee:"", truth:65, prob:50, light:"y", trend:"up", note:"Talks ongoing; Celtic stated position that player is not for sale", lastSeen:"2026-08-08T18:06:11Z", baseProb:50}
];
const OUTGOING = [
  {name:"Mateus Fernandes", sub:"21 · Portugal · Midfielder", club:"West Ham", pos:"Midfielder", report:"West Ham intend to demand £80 million for Mateus Fernandes", src:"Unknown", tier:3, fee:"£80m", truth:70, prob:45, light:"y", trend:"down", note:"Valuation set; no confirmed buyer or advanced talks reported", lastSeen:"2026-08-08T18:06:11Z", baseProb:45}
];
const RISERS = [
