...
const INCOMING = [
  {name:"Ousmane Diao", sub:"Centre-back · Senegal", club:"Unknown", pos:"CB", report:"Palace have identified the Senegalese centre-back", src:"On-page", tier:3, fee:"Unknown", truth:70, prob:60, light:"g", trend:"up", note:"Identified target, no recent credible update", lastSeen:"2026-08-06T14:09:02Z", baseProb:60},
  {name:"Igor Julio", sub:"Centre-back · Brighton", club:"Brighton & Hove Albion", pos:"CB", report:"The young Brighton centre-back has emerged as a target", src:"On-page", tier:3, fee:"Unknown", truth:65, prob:55, light:"g", trend:"up", note:"Emerged as target, no recent credible update", lastSeen:"2026-08-06T14:09:02Z", baseProb:55},
  {name:"Takehiro Tomiyasu", sub:"Defender · Japan", club:"Arsenal", pos:"FB", report:"Palace have agreed a free transfer", src:"On-page", tier:3, fee:"Free", truth:75, prob:70, light:"g", trend:"up", note:"Agreement reported, awaiting completion", lastSeen:"2026-08-06T14:09:02Z", baseProb:70},
  {name:"Solly March", sub:"Winger · England", club:"Brighton & Hove Albion", pos:"W", report:"Palace are considering a move for the winger", src:"On-page", tier:3, fee:"Unknown", truth:60, prob:50, light:"y", trend:"up", note:"Being considered, no recent credible update", lastSeen:"2026-08-06T14:09:02Z", baseProb:50},
  {name:"Real Salt Lake wing-back", sub:"Wing-back · Unknown", club:"Real Salt Lake", pos:"WB", report:"Crystal Palace in advanced talks over £11m deal", src:"The Athletic", tier:2, fee:"£11m", truth:80, prob:75, light:"g", trend:"up", note:"Advanced negotiations", lastSeen:"2026-08-06T14:09:02Z", baseProb:75}
];

const OUTGOING = [
  {name:"Adam Wharton", sub:"Midfielder · England", club:"Crystal Palace", pos:"CM", report:"Adam Wharton linked with departure", src:"On-page", tier:3, fee:"Unknown", truth:65, prob:60, light:"g", trend:"up", note:"Departure speculation, no recent credible update", lastSeen:"2026-08-06T14:09:02Z", baseProb:60},
  {name:"Jean-Philippe Mateta", sub:"Striker · France", club:"Crystal Palace", pos:"ST", report:"After a January transfer request and prior interest", src:"On-page", tier:3, fee:"Unknown", truth:70, prob:65, light:"g", trend:"up", note:"Transfer request filed, no recent credible update on current status", lastSeen:"2026-08-06T14:09:02Z", baseProb:65},
  {name:"Eberechi Eze", sub:"Midfielder · England", club:"Crystal Palace", pos:"CM", report:"Arsenal reach agreement in principle to sign Eberechi Eze", src:"On-page", tier:3, fee:"£68m", truth:80, prob:75, light:"g", trend:"up", note:"Agreement in principle reached", lastSeen:"2026-08-06T14:09:02Z", baseProb:75},
  {name:"Marc Guehi", sub:"Centre-back · France", club:"Crystal Palace", pos:"CB", report:"Liverpool bid £35m for Marc Guehi. Medical undergoing", src:"On-page", tier:3, fee:"£35m", truth:85, prob:80, light:"g", trend:"up", note:"Medical in progress", lastSeen:"2026-08-06T14:09:02Z", baseProb:80}
];
const DEAD = [
