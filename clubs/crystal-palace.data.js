...
const INCOMING = [
  {name:"Ousmane Diao", sub:"Centre-back · Senegal", club:"Unknown", pos:"CB", report:"Palace have identified the Senegalese centre-back", src:"On-page rumour", tier:3, fee:"Unknown", truth:65, prob:50, light:"y", trend:"up", note:"Identified target, no recent credible update", lastSeen:"2026-08-06T14:04:24Z", baseProb:50},
  {name:"Igor Julio", sub:"Centre-back · Brighton", club:"Brighton", pos:"CB", report:"The young Brighton centre-back has emerged as a target", src:"On-page rumour", tier:3, fee:"Unknown", truth:60, prob:40, light:"y", trend:"up", note:"Emerged as target, no recent credible update", lastSeen:"2026-08-06T14:04:24Z", baseProb:40},
  {name:"Takehiro Tomiyasu", sub:"Defender · Arsenal", club:"Arsenal", pos:"DEF", report:"Palace have agreed a free transfer for the former Arsenal defender", src:"On-page rumour", tier:3, fee:"Free", truth:70, prob:60, light:"g", trend:"up", note:"Agreement reported, awaiting completion", lastSeen:"2026-08-06T14:04:24Z", baseProb:60},
  {name:"Solly March", sub:"Winger · Brighton", club:"Brighton", pos:"W", report:"Palace are considering a move for the winger", src:"On-page rumour", tier:3, fee:"Unknown", truth:55, prob:35, light:"y", trend:"up", note:"Being considered, no recent credible update", lastSeen:"2026-08-06T14:04:24Z", baseProb:35},
  {name:"Real Salt Lake wing-back", sub:"Wing-back · Real Salt Lake", club:"Real Salt Lake", pos:"WB", report:"Crystal Palace in advanced talks over £11m deal", src:"The Athletic", tier:2, fee:"£11m", truth:75, prob:70, light:"g", trend:"flat", note:"Advanced talks stage", lastSeen:"2026-08-06T14:04:24Z", baseProb:70}
];

const OUTGOING = [
  {name:"Adam Wharton", sub:"Midfielder · Palace", club:"Crystal Palace", pos:"MID", report:"Adam Wharton linked with departure", src:"On-page rumour", tier:3, fee:"Unknown", truth:65, prob:50, light:"y", trend:"up", note:"Departure speculation, no recent credible update", lastSeen:"2026-08-06T14:04:24Z", baseProb:50},
  {name:"Jean-Philippe Mateta", sub:"Forward · Palace", club:"Crystal Palace", pos:"FW", report:"After a January transfer request and prior interest from other clubs", src:"On-page rumour", tier:3, fee:"Unknown", truth:60, prob:45, light:"y", trend:"up", note:"Transfer request filed, no recent credible update on current status", lastSeen:"2026-08-06T14:04:24Z", baseProb:45},
  {name:"Eberechi Eze", sub:"Midfielder · Palace", club:"Crystal Palace", pos:"MID", report:"Arsenal reach agreement in principle to sign Eberechi Eze", src:"David Ornstein / The Athletic", tier:3, fee:"£68m", truth:70, prob:65, light:"g", trend:"down", note:"Agreement in principle", lastSeen:"2026-08-06T14:04:24Z", baseProb:65},
  {name:"Marc Guehi", sub:"Centre-back · Palace", club:"Crystal Palace", pos:"CB", report:"Liverpool bid £35m for Marc Guehi. Medical undergoing", src:"David Ornstein / The Athletic", tier:3, fee:"£35m", truth:75, prob:70, light:"g", trend:"up", note:"Medical stage", lastSeen:"2026-08-06T14:04:24Z", baseProb:70}
];
const DEAD = [
