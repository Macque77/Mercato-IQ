...
const CONFIRMED_OUT = [
  ...
  {name:"Zeki Celik", sub:"Turkey · RB", club:"AS Roma", pos:"RB", fee:"Undisclosed", free:false, status:"done", statusTxt:"DONE, OFFICIAL", note:"Heading to Juventus"}
];
...
const HUB = {
  ...
  tuttomercatowebZekiCelik: {l:"Tuttomercatoweb", u:"https://www.tuttomercatoweb.com/"}};
...
const LINKMAP = {
  ...
  "Zeki Celik": ["gianlucaDiMarzioGivairoRead", "tuttomercatowebZekiCelik"]};
const WL_LINKMAP = {
