...
const INCOMING = [
  {name:"Ernest Poku", sub:"22 · Netherlands · RW", club:"Bayer Leverkusen", pos:"RW", report:"Leverkusen have made Poku available at around €25m and set a deadline on his sale. Sport Bild says he is on the verge of a Premier League move, with Sunderland and Nottingham Forest the interested parties.", src:"Sport Bild", tier:2, fee:"£21m (€25m)", truth:78, prob:45, light:"y", trend:"up", note:"Original reporting is Sport Bild; no English tier-one has put Sunderland at the front of the queue yet, and Forest are also in.", lastSeen:"2026-08-06T11:36:31Z", baseProb:45},
  {name:"Dayann Methalie", sub:"20 · France · LB", club:"Toulouse", pos:"LB", report:"Personal terms are agreed on a five-year deal and Sunderland are in club-to-club talks. Toulouse want €30m fixed, while no suitor has gone beyond €25m guaranteed. Methalie's only priority is Sunderland.", src:"Santi Aouna (Foot Mercato) / Fabrice Hawkins (RMC Sport)", tier:1, fee:"€30m asking price", truth:92, prob:65, light:"g", trend:"up", note:"Well sourced on both sides of the Channel; the gap is purely the fixed fee.", lastSeen:"2026-08-06T11:36:31Z", baseProb:65},
  {name:"Matías Galarza", sub:"24 · Paraguay · CM", club:"River Plate", pos:"CM", report:"~4 wks ago", src:"Football FanCast", tier:3, fee:"~£4-6m", truth:38, prob:8, light:'r', trend:'down',
   note:"Fading further: Football FanCast's own update names Olympiacos and Getafe as the clubs actually in pole position, with no fresh Sunderland step reported. With Sadiki and Xhaka both staying, only a depth need remains in central midfield. Drifting into the Rumour Mill.", lastSeen:"2026-08-04T19:10:50Z", baseProb:8},
  ...
  {name:"Geny Catamo", sub:"25 · Mozambique · RW", club:"Sporting CP", pos:"RW", report:"Sunderland have opened talks with Sporting over the Mozambique winger as Florent Ghisolfi hunts a right-sided attacker. Sporting have signalled they will only sell if the release clause is met, and the player is said to be keen on the move.", src:"James Copley, Sunderland Echo", tier:2, fee:"€60m release clause (£51m)", truth:82, prob:25, light:"o", trend:"flat", note:"Talks are real but the clause makes this a club-record outlay; Sporting are not negotiating below it, and Brighton, Brentford, Fulham and Everton have all been linked.", lastSeen:"2026-08-06T11:36:31Z", baseProb:25},
...
const OUTGOING = [
  ...
  {name:"Simon Adingra", sub:"24 · Ivory Coast · W", club:"West Ham United", pos:"W", report:"West Ham have made a loan enquiry which is under discussion between the clubs. Sunderland, who paid £20.5m to Brighton last summer, would prefer a permanent exit.", src:"Keith Downie, Sky Sports", tier:2, fee:"Loan", truth:90, prob:55, light:"g", trend:"up", note:"Roma, RB Leipzig, Monaco, Ipswich and Hull have all been mentioned, so the destination is far from settled.", lastSeen:"2026-08-06T11:36:31Z", baseProb:55},
  {name:"Granit Xhaka", sub:"33 · CM · leader", club:"Chelsea / Man Utd", pos:"CM", report:"~4 wks ago", src:"Sky Sports (Downie/Sheth)", tier:2, fee:"£8m bid rejected", truth:82, prob:5, light:'r', trend:'flat',
   note:"Resolved: staying. Chelsea's £8m opening bid was rejected out of hand and Sunderland made a public 'power play' of their stance; the captain is committed with two years left and the Europa pull. No change this refresh; the sale angle is closed.", lastSeen:"2026-08-04T19:10:50Z", baseProb:5},
  {name:"Wilson Isidor", sub:"25 · France · ST", club:"West Ham United", pos:"ST", report:"West Ham have hit a setback in their pursuit of the striker, with Sunderland reluctant on the terms offered. Cagliari have also asked about him.", src:"Keith Downie, Sky Sports", tier:2, fee:"Undisclosed", truth:80, prob:30, light:"y", trend:"up", note:"Reported as stalling rather than progressing; Sunderland are not pushing him out.", lastSeen:"2026-08-06T11:36:31Z", baseProb:30},
  {name:"Brian Brobbey", sub:"24 · ST · NED", club:"Man Utd / Everton / Bayern", pos:"ST", report:"~2 wks ago", src:"Football Transfers / Peoples Person", tier:3, fee:"£30-34m+", truth:56, prob:16, light:'o', trend:'flat',
   note:"Wanted after a strong World Cup, but not cheaply, and no fresher reporting found this refresh. Manchester United have weighed a move, Everton are linked and Bayern have surfaced on aggregator feeds, with Sunderland's ask reported around £34m. He is the senior striker with Mayenda gone and is central to the two-striker plan; no agreed deal, holding firm.", lastSeen:"2026-08-04T19:10:50Z", baseProb:16},
...
const LINKMAP = {
  ...
  "Simon Adingra": ["adingraHT","adingraReshuffle","adingraVGR", "sunderlandEchoSimonAdingra", "keithDownieSkySportsSimonAdingra"],
  "Arthur Masuaku": ["masuakuFP","masuakuEcho2","masuakuEcho", "souleEcho2", "fanatik"],
  "Granit Xhaka": ["skyXhaka","xhakaEcho"],
  "Wilson Isidor": ["sportsboom","echo", "skySportsWilsonIsidor"],
  ...
  "Thomas Meunier": ["meunier","meunierGFFN", "yahooSportsThomasMeunier", "footballFanCastEliezerMayenda", "sunderlandAFCThomasMeunier", "davidOrnsteinTheAthleticThomasMeunier"],
  "Eliezer Mayenda": ["mayendaRennes","gffn", "footballFanCastEliezerMayenda", "aFPviaFrance24EliezerMayenda", "sunderlandAFCofficialannouncementclubrecordEliezerMayenda", "lequipe"],
