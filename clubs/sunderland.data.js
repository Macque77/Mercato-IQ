...
const INCOMING = [
  {name:"Ernest Poku", sub:"22 · Netherlands U21 · RW", club:"Bayer Leverkusen", pos:"RW", report:"~2 days ago", src:"Football FanCast / Get German Football News", tier:3, fee:"~£21m (€25m)", truth:60, prob:32, light:'y', trend:'up',
   note:"Live again with a real deadline attached: Leverkusen have reportedly set 1 Aug as their internal cutoff to sell, with Sunderland described as favourites and 'almost certain to join an English club', at a fee around €25m/£21m. Nottingham Forest remain competing, but the imminent deadline is a genuine forcing mechanism that lifts this above the drift of the last refresh.", lastSeen:"2026-08-04T19:10:50Z", baseProb:32},
...
const OUTGOING = [
  ...
  {name:"Robin Roefs", sub:"23 · GK", club:"Chelsea / Liverpool", pos:"GK", report:"~9 wks ago", src:"aggregated / O'Rourke", tier:3, fee:"£45-55m", truth:48, prob:10, light:'r', trend:'flat',
   note:"Courted at the top of the league but going nowhere. He is the established No.1 after an impressive first season, precisely why Patterson is the one leaving, and Sunderland have no need to sell on a deal to 2030. No fresh movement; quiet.", lastSeen:"2026-08-04T19:10:50Z", baseProb:10},
  {name:"Enzo Le Fée", sub:"26 · CM/AM", club:"Liverpool / Villa / Arsenal", pos:"CM/AM", report:"~9 wks ago", src:"SportsBoom / Fichajes", tier:3, fee:"£22-30m", truth:44, prob:14, light:'r', trend:'down',
   note:"Several Champions-League-chasing clubs linked, but the player has played it down as 'the media part' and Sunderland have no need to sell above his ~€23m arrival cost. No fresh reporting found this refresh; flagged as stale.", lastSeen:"2026-08-04T19:10:50Z", baseProb:14},
  {name:"Chemsdine Talbi", sub:"20 · Morocco · RW", club:"Villa / Brighton / Napoli", pos:"RW", report:"~cooled", src:"SportsBoom", tier:3, fee:"£25-35m", truth:40, prob:12, light:'r', trend:'flat',
   note:"Broad monitoring of a prized young winger only a year in; any sale would be at a steep premium with Sunderland holding the cards, and with wide attack now a need the club would resist letting him go. No concrete bid, no fresh reporting this refresh.", lastSeen:"2026-08-04T19:10:50Z", baseProb:12},
  {name:"Trai Hume", sub:"24 · NI · RB", club:"Brighton / Real Madrid", pos:"RB", report:"~11 wks ago", src:"aggregated / TEAMtalk", tier:4, fee:"£20-30m", truth:34, prob:10, light:'r', trend:'flat',
   note:"Brighton interest is plausible but quiet, and with Meunier now added Sunderland have cover rather than pressure. Under contract to 2030, so the holder's price applies. No fresh reporting this refresh.", lastSeen:"2026-08-04T19:10:50Z", baseProb:10},
  {name:"Habib Diarra", sub:"22 · CM · club-record", club:"Galatasaray", pos:"CM", report:"~11 wks ago", src:"Turkish press", tier:4, fee:"£35m+", truth:20, prob:6, light:'r', trend:'flat',
   note:"Galatasaray's planning touched the club-record signing. Very unlikely: a cornerstone bought last summer whom Sunderland would resist hard and price prohibitively. No fresh reporting this refresh.", lastSeen:"2026-08-04T19:10:50Z", baseProb:6}
];
...
const LINKMAP = {
  ...
  "Dayann Methalie": ["methalieGFFN","methalieCloarec","methalieBoost","methalieEcho2","methalieRT", "adingraReshuffle"],
  ...
  "Simon Adingra": ["adingraHT","adingraReshuffle","adingraVGR", "sunderlandEchoSimonAdingra"],
  "Arthur Masuaku": ["masuakuFP","masuakuEcho2","masuakuEcho", "souleEcho2"],
