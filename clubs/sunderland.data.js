...
const OUTGOING = [
  ...
  {name:"Noah Sadiki", sub:"21 · DR Congo · DM/CM", club:"Man Utd / City / Chelsea / Arsenal", pos:"DM/CM", report:"~2 wks ago", src:"Tavolieri / TEAMtalk", tier:2, fee:"£55-65m+", truth:86, prob:18, light:'o', trend:'flat',
   note:"The crown jewel, and Sunderland are blocking. Manchester United, Manchester City and Chelsea are all keen and Arsenal have now been linked too, but the club's stance is unequivocal: not for sale this summer, contracted long term, integral to Le Bris. No fresh movement this refresh; the firm no keeps completion low.", lastSeen:"2026-08-04T19:10:50Z", baseProb:18, dead:true, deadReason:"no longer a current link"},
  ...
  {name:"Romaine Mundle", sub:"22 · LW", club:"Rangers / continental", pos:"LW", report:"~3 wks ago", src:"Sunderland Echo / Voetbalnieuws", tier:3, fee:"£10-16m", truth:48, prob:24, light:'o', trend:'down',
   note:"No fresh reporting found this refresh; still recovering from summer surgery and held out as a precaution in pre-season. Rangers and various continental clubs remain credited from the last cycle, but this has gone quiet - flagged as stale.", lastSeen:"2026-08-04T19:10:50Z", baseProb:24, dead:true, deadReason:"no longer a current link"},
...
const WATCHLIST = [
  {name:"Arne Engels", club:"Celtic", pos:"CM", dir:"in", age:"~3 wks", tier:3, note:"Moving, but toward Nottingham Forest, who lead the race; Sunderland were only ever tracking alongside several clubs, with no offer.", dead:true, deadReason:"rumour ~3 weeks old, no fresh snippet support"},
  {name:"Yassine Titraoui", club:"Charleroi", pos:"DM/CM", dir:"in", age:"~2 days", tier:3, note:"Back on the feeds: Belgian/French press had an offer and a player preference for Sunderland earlier in the summer; a genuine on-model holder, but no confirmed fresh bid, so monitoring.", dead:true, deadReason:"rumour ~2 days old but no snippet provided, stale"},
  {name:"Aaron Wan-Bissaka", club:"West Ham", pos:"RB", dir:"in", age:"~stale", tier:4, note:"Relegated West Ham open to selling; experienced cover, but off the youth model and now surplus with Meunier in and Hume around.", dead:true, deadReason:"marked as stale on page, no snippet support"},
