...
const INCOMING = [
  {name:"Junior Mwanga", sub:"", club:"", pos:"", report:"Le Havre to bring back Junior Mwanga", src:"MadeInFOOT", tier:3, fee:"", truth:65, prob:65, light:"g", trend:"flat", note:"Repatriation reported", lastSeen:"2026-08-08T18:06:11Z", baseProb:65}
];

const OUTGOING = [
  {name:"Yanis Zouaoui", sub:"Unknown · Unknown · Unknown", club:"Nantes", pos:"Unknown", report:"Nantes on the brink of full agreement with Le Havre for Yanis Zouaoui", src:"Score.fr", tier:3, fee:"Undisclosed", truth:85, prob:85, light:"g", trend:"up", note:"Imminent agreement reported", lastSeen:"2026-08-08T18:06:11Z", baseProb:85},
  {name:"Elias Jelert", sub:"Unknown · Unknown · Latéral", club:"Galatasaray", pos:"LB", report:"Le Havre in discussions with Galatasaray for loan of Elias Jelert", src:"MercatoLive", tier:3, fee:"Loan", truth:70, prob:70, light:"g", trend:"up", note:"Loan move being discussed", lastSeen:"2026-08-08T18:06:11Z", baseProb:70}
];
...
const WATCHLIST = [
  {name:"Timothée Pembélé", club:"Le Havre AC", pos:"LB", dir:"out", age:"~3 weeks", tier:2, note:"Sunderland reported set to make his loan move permanent.", dead:true, deadReason:"No recent snippet support (last mentioned ~3 weeks ago)"}
];
...
const HUB = {
  ...
  mercatoLiveEliasJelert1: {l:"MercatoLive", u:"https://news.google.com/rss/articles/CBMipAFBVV95cUxPaTN4QndqSGZuZzVLQk9vV2RPaXVfa0VNaUVRY0V0djZRZTZoa2xxSU5vamc4X2hmOW9CTm92MWFmLXlqZU5IUk9Qbm9ueE5XNl9vRTlsTXl3cXppS2p4M2g2NVNiaWlBbUttaFBJTmxPNVRqR2FqSUFiNXg4bWdPZ1F1SnJDV01vUW9sZFRCX2t3TXFrek82LW1NYzdKeTV2WUpTcw"}};
...
const LINKMAP = {
  ...
  "Elias Jelert": ["mercatoLiveEliasJelert", "mercatoLiveEliasJelert1"]};
const WL_LINKMAP = {
  "Timothée Pembélé": ["gffn-lehavre"]
};
