...
const CONFIRMED_IN = [
  ...
  {name:"Juanlu Sanchez", sub:"21 · Spain · D", club:"Sevilla", pos:"D", fee:"Undisclosed", free:false, status:"done", statusTxt:"DONE, OFFICIAL", note:"Transfer completed from Sevilla"}
];
const CONFIRMED_OUT = [
...
const INCOMING = [
  {name:"Juanlu Sanchez", sub:"21 · Spain · D", club:"Sevilla", pos:"D", report:"Sevilla defender joins Bournemouth", src:"BBC", tier:2, fee:"Undisclosed", truth:100, prob:100, light:"g", trend:"flat", note:"Transfer completed", lastSeen:"2026-08-08T18:06:10Z", baseProb:100},
  {name:"Antonio Silva", sub:"20 · Portugal · D", club:"Benfica", pos:"D", report:"Bournemouth agree surprise transfer for former Man Utd target at fraction of £87m release clause", src:"The Sun", tier:3, fee:"Undisclosed", truth:95, prob:95, light:"g", trend:"up", note:"Deal agreed, below release clause", lastSeen:"2026-08-08T18:06:10Z", baseProb:95}
];
const OUTGOING = [
  {name:"Alex Scott", sub:"21 · England · Defender", club:"Bournemouth", pos:"Defender", report:"Arsenal and Manchester United interest in Bournemouth defender", src:"Unknown", tier:3, fee:"Undisclosed", truth:50, prob:50, light:"y", trend:"flat", note:"Interest from top clubs reported", lastSeen:"2026-08-08T16:04:56Z", baseProb:50, dead:true, deadReason:"No recent credible reports; Arsenal/Manchester United interest not substantiated in snippets"}
];
const DEAD = [
...
const HUB = {
  ...
  theSunAntonioSilva1: {l:"The Sun", u:"https://news.google.com/rss/articles/CBMimwFBVV95cUxNTDRLNDF0VFBjQ2w1anNyZkhGNW9fLW56UUJOT0M0Um0xV1FiLURhVDVncUp1Rl9JQ2I1MzVJTzloeGdrc3NTNXEwRlhPOUVZS3VIT2lHMkh1NUd4ZW0zR0RDb2VZemtsUWM3TVQwWU02VWFZVzBGQ3dIazFNVng0Z0hBVDJpN3JXVHVMT2ZkMUVNMjMzYlQ0RDRrZw?oc=5"}};
const LINKMAP = {
  ...
  "Avom & Hadj Moussa": [],
  "Antonio Silva": ["eSPNcitingNicoloSchiraAntonioSilva", "skySportsAntonioSilva", "theSunAntonioSilva", "eSPNAntonioSilva", "eSPNAntonioSilva1", "theSunAntonioSilva1"],
