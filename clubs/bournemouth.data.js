...
const INCOMING = [
  {name:"Malik Tillman", sub:"AM · USA", club:"Bayer Leverkusen", pos:"AM", report:"~5 wks ago", src:"TeamTalk / ESPN", tier:3, fee:"£25-35m", truth:55, prob:25, light:'o', trend:'flat',
   note:"Bournemouth are credited with joining the race for the USMNT attacker, who would link up with Tyler Adams. OBSTACLE: a reported ~€35m clause for Bayern could shape the price; competition exists."},
  ...
  {name:"Avom & Hadj Moussa", sub:"Recycled aggregator links", club:"Aggregated feeds", pos:"-", report:"~60d+ / recycled", tier:4, fee:"n/a", truth:25, prob:8, light:'r', trend:'down',
   note:"Carried from the last build's method note: recycled aggregator repetition does not refresh recency, and both links fall on this basis. Not treated as live unless freshly re-reported by a named original source."},
];
const OUTGOING = [
