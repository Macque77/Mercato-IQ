...
const INCOMING = [
  {name:"Juanlu Sanchez", sub:"21 · Spain · Defender", club:"Sevilla", pos:"Defender", report:"Sevilla defender joins Bournemouth", src:"BBC", tier:2, fee:"Undisclosed", truth:100, prob:100, light:"g", trend:"flat", note:"Deal confirmed", lastSeen:"2026-08-08T16:04:56Z", baseProb:100},
  {name:"Antonio Silva", sub:"21 · Portugal · Defender", club:"Benfica", pos:"Defender", report:"Bournemouth agree surprise transfer for former Man Utd target", src:"The Sun", tier:3, fee:"Fraction of £87m release clause", truth:90, prob:90, light:"g", trend:"up", note:"Deal agreed below release clause", lastSeen:"2026-08-08T16:04:56Z", baseProb:90}
];
const OUTGOING = [
  {name:"Alex Scott", sub:"21 · England · Defender", club:"Bournemouth", pos:"Defender", report:"Arsenal and Manchester United interest in Bournemouth defender", src:"Unknown", tier:3, fee:"Undisclosed", truth:50, prob:50, light:"y", trend:"flat", note:"Interest from top clubs reported", lastSeen:"2026-08-08T16:04:56Z", baseProb:50}
];
const DEAD = [
