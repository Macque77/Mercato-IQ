...
const INCOMING = [
  ...
  {name:"Nestory Irankunda", sub:"20 · W · Australia", club:"Watford", pos:"W", report:"31 Jul 2026", src:"Nicolo Schira", tier:1, fee:"~€22m (bonuses included)", truth:55, prob:45, light:"y", trend:"flat", note:"Schira: agreement in principle on personal terms to 2031, with Sporting racing other suitors to close the deal."}
];
const OUTGOING = [
  {name:"Daniel Braganca", sub:"24 · MF · Portugal", club:"Olympiacos", pos:"MF", report:"1 Aug 2026", src:"A Bola / Record / SportTV", tier:2, fee:"~€10m bid tabled", truth:55, prob:40, light:"y", trend:"up", note:"Olympiacos have tabled around €10m for the fringe midfielder, with A Bola describing his Sporting future as 'almost resolved' - i.e. leaving."},
  {name:"Morten Hjulmand", sub:"26 · MF · Denmark", club:"Real Madrid", pos:"MF", report:"Jul 2026", src:"Goal.com", tier:2, fee:"No formal bid reported", truth:45, prob:15, light:"o", trend:"flat", note:"The Sporting captain has himself called Real Madrid interest 'a great honour' - a long-running, still-live storyline, though no formal bid has been reported."}
];
const RISERS = [
