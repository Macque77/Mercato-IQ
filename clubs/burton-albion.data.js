...
const INCOMING = [
  ...
  {name:"Brad Collins", sub:"Coventry City · GK", club:"Coventry City", pos:"GK", report:"Burton Albion targeting permanent deal for Coventry keeper", src:"SportsBoom UK", tier:3, fee:"Undisclosed", truth:75, prob:60, light:"g", trend:"up", note:"Loan player, permanent move being pursued", lastSeen:"2026-08-08T11:19:01Z", baseProb:60}
];
const OUTGOING = [
