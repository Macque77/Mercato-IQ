...
const INCOMING = [
  ...
  {name:"Brad Collins", sub:"Coventry City · GK", club:"Coventry City", pos:"GK", report:"Burton Albion targeting permanent deal for Coventry keeper", src:"SportsBoom UK", tier:3, fee:"Undisclosed", truth:70, prob:60, light:"g", trend:"flat", note:"Loan player; permanent move being pursued", lastSeen:"2026-08-08T14:10:31Z", baseProb:60}
];
const OUTGOING = [
