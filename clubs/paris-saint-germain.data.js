...
const INCOMING = [
  ...
  {name:"Zion Suzuki", sub:"23 · Japan · GK", club:"Parma", pos:"GK", report:"PSG have gone to the front of the queue for the Japan international, sending a formal bid to Parma and presenting their sporting project to the player, whose role would be built around Lucas Chevalier's next step. Parma are ready to negotiate and Juventus, long-time admirers, have slipped behind.", src:"Fabrizio Romano / Gianluca Di Marzio", tier:1, fee:"Around €33m with add-ons", truth:92, prob:74, light:"g", trend:"up", note:"The two tier-one accounts do not match on money: Romano says a €33m package, Di Marzio around €28m plus bonuses. Structure is clearly still being worked on, so treat the figure as fluid.", lastSeen:"2026-08-06T10:49:40Z", baseProb:74},
...
const LINKMAP = {
  ...
  "Bradley Barcola": ["fabrizioRomanoviaCaughtOffsideBradleyBarcola", "getFrenchFootballNewsFabrizioRomanoBradleyBarcola", "teamTalkrelayingFabrizioRomanoBradleyBarcola"],
  "Zion Suzuki": ["getFrenchFootballNewsFabrizioRomanoZionSuzuki", "gianlucadimarziocomZionSuzuki"],
