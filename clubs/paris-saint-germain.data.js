...
const OUTGOING = [
  ...
  {name:"Ibrahim Mbaye", sub:"Premier League and Bundesliga circling academy winger", club:"Manchester City (shortlisted)", pos:"RW", report:"PSG's 18-year-old academy forward Mbaye has been shortlisted by Manchester City, with Aston Villa, Tottenham and Borussia Dortmund also interested.", src:"Get French Football News", tier:3, fee:"Undisclosed", truth:45, prob:35, light:"y", trend:"flat", note:"Highly rated prospect with growing international experience"}
];
