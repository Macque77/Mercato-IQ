...
const INCOMING = [
  {name:"Jordan Thomas", sub:"Unknown · Unknown · Unknown", club:"Cheltenham Town", pos:"Unknown", report:"Agrees move from Cheltenham Town", src:"Gloucestershire Live", tier:3, fee:"Unknown", truth:85, prob:90, light:"g", trend:"up", note:"Deal agreed after Cheltenham Town exit", lastSeen:"2026-08-07T17:40:24Z", baseProb:90}
];
const OUTGOING = [
  {name:"Luke Molyneux", sub:"Unknown · Unknown · Unknown", club:"Doncaster Rovers", pos:"Unknown", report:"Deal agreed with League Two club", src:"Doncaster Free Press", tier:3, fee:"Unknown", truth:80, prob:85, light:"g", trend:"down", note:"Double transfer movement pending; deal 'agreed' with L2 club", lastSeen:"2026-08-07T17:40:24Z", baseProb:85},
...
const LINKMAP = {
  ...
  "Luke Molyneux": ["src-benwignall", "flw", "doncasterFreePressLukeMolyneux", "doncasterFreePressLukeMolyneux1", "doncasterFreePressLukeMolyneux2"],
  "Owen Bailey": ["gnews-owenbailey", "yorkshirePostOwenBailey", "yorkshirePostOwenBailey1"],
  "Jordan Thomas": ["gloucestershireLiveJordanThomas", "gloucestershireLiveJordanThomas1"]};
const WL_LINKMAP = {};
