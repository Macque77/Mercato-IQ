...
const CONFIRMED_IN = [
  {name:"Jack Butland", sub:"33 · GK · England", club:"Rangers", pos:"GK", fee:"£3m", free:false, status:"done", statusTxt:"DONE, OFFICIAL", note:"Part of a straight goalkeeper swap: Butland moves to Hull as Ivor Pandur heads the other way to Rangers."},
  {name:"Oscar Zambrano", sub:"22 · DM · Ecuador", club:"NK Maribor", pos:"MF", fee:"Undisclosed", free:false, status:"done", statusTxt:"DONE, OFFICIAL", note:"Permanent return for the Ecuadorian after a 2024 loan spell at Hull; signs a four-year deal with a further 12-month option."},
...
const CONFIRMED_OUT = [
  ...
  {name:"Ivor Pandur", sub:"24 · GK · Croatia", club:"Rangers", pos:"GK", fee:"£6m", free:false, status:"done", statusTxt:"DONE, OFFICIAL", note:"Croatian goalkeeper moves to Rangers in the swap deal that brought Jack Butland to Hull."},
  {name:"Kasey Palmer", sub:"27 · AM · England", club:"Luton Town", pos:"MF", fee:"Undisclosed", free:false, status:"done", statusTxt:"DONE, OFFICIAL", note:"Attacking midfielder moves on as Hull reshapes its squad for the top flight."},
  {name:"Kyle Joseph", sub:"23 · ST · England", club:"Middlesbrough", pos:"FW", fee:"Undisclosed", free:false, status:"done", statusTxt:"DONE, OFFICIAL", note:"Young striker departs for Championship side Middlesbrough."}
];
...
const INCOMING = [
  ...
  {name:"Leon Bailey", sub:"27 · Jamaica · W", club:"Aston Villa", pos:"W", report:"Owner Acun Ilicali confirmed permanent move; medical stage", src:"Hull City official", tier:1, fee:"Undisclosed", truth:95, prob:95, light:"g", trend:"up", note:"Owner confirmation reported", lastSeen:"2026-08-08T18:06:10Z", baseProb:95},
  {name:"Manor Solomon", sub:"25 · Israel · W", club:"Tottenham Hotspur", pos:"Winger", report:"Hull City rivals West Ham for £20m Tottenham forward", src:"Transfer rumour", tier:3, fee:"£20m", truth:45, prob:30, light:"y", trend:"down", note:"Competing with West Ham", lastSeen:"2026-08-08T16:04:57Z", baseProb:30, dead:true, deadReason:"no longer a current link"},
  {name:"Jens Hjertø-Dahl", sub:"20 · Norway · M", club:"Molde", pos:"M", report:"Signed on five-year deal, club-record £8m transfer", src:"BBC Sport", tier:2, fee:"£8m", truth:100, prob:100, light:"g", trend:"flat", note:"Deal completed and announced", lastSeen:"2026-08-08T18:06:10Z", baseProb:100},
  {name:"Dimitar Tzolakis", sub:"24 · Greece · GK", club:"Olympiakos", pos:"GK", report:"Signed from Olympiakos in club-record transfer", src:"Hull City official", tier:1, fee:"Club-record", truth:100, prob:100, light:"g", trend:"flat", note:"Deal completed", lastSeen:"2026-08-08T18:06:10Z", baseProb:100},
  {name:"Konstantinos Tzolakis", sub:"27 · Greece · GK", club:"Olympiakos", pos:"GK", report:"Signed from Olympiakos in club-record transfer", src:"Hull City official", tier:1, fee:"Club-record", truth:100, prob:100, light:"g", trend:"flat", note:"Deal completed", lastSeen:"2026-08-08T18:06:10Z", baseProb:100}
];
...
const HUB = {
  ...
  yahooSportsIlicaliconfirmationKonstantinosTzolakis: {l:"Yahoo Sports (Ilicali confirmation)", u:"https://sports.yahoo.com/articles/hull-owner-ilicali-confirms-tzolakis-150022197.html"},
  bBCSportHullLiveSorbaThomas: {l:"BBC Sport (HullLive)", u:"https://feeds.bbci.co.uk/sport/football/articles/c0lzk0e9xlgo"},
  skySportsJackButland: {l:"Sky Sports", u:"https://www.skysports.com/football/news/11095/13559364/ivor-pandur-rangers-sign-croatia-goalkeeper-from-hull-city-with-jack-butland-close-to-joining-tigers"},
  tribalFootballOscarZambrano: {l:"TribalFootball", u:"https://www.tribalfootball.com/article/soccer-premier-league-done-deal-hull-city-confirm-permanent-oscar-zambrano-return-beb3d0b7-01ce-4d93-b27f-a6ffae4e813f"},
  theYorkshirePostMattTargett: {l:"The Yorkshire Post", u:"https://www.yorkshirepost.co.uk/sport/football/middlesbrough-fc/hull-city-transfer-latest-ex-middlesbrough-fc-loanee-matt-targett-joins-from-newcastle-united-8816927"},
  ...
  bBCSportJensHjertDahl3: {l:"BBC Sport", u:"https://www.bbc.com/sport/football"}};
const LINKMAP = {
  ...
  "Konstantinos Tzolakis": ["yahooSportsIlicaliconfirmationKonstantinosTzolakis", "hullLiveKonstantinosTzolakis", "ownerconfirmationKonstantinosTzolakis", "bBCSportKonstantinosTzolakis", "hullCitypageManorSolomon", "hullCityOfficialLeonBailey"],
  ...
  "Hidemasa Morita": ["theYorkshirePostHidemasaMorita"],
  "Oli McBurnie": ["bBCSportOliMcBurnie"],
  "Semi Ajayi": ["bBCSportSemiAjayi"],
  ...
  "Jens Hjertø-Dahl": ["hullLiveJensHjertDahl", "bBCSportJensHjertDahl", "bBCSportJensHjertDahl1", "bBCSportJensHjertDahl2", "bBCSportJensHjertDahl3"],
...
`,
  ...
  methodLegend: `
      ...
      <div class="col">
        ...
        <div class="row" style="margin-top:14px"><span class="k" style="colour:var(--gold)">TRUE?</span><span>Probability the reported interest is <b>real and accurately sourced</b> - the credibility of the link itself, driven by tier, corroboration and recency. Pre-window framing rows carry a neutral T3 baseline until sourced links replace them.</span></div>
